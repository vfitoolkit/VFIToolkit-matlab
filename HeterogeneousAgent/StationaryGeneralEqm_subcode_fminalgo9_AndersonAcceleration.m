...
% conditions, the shooting map, the distance) and then calls the Anderson
% Acceleration core, AndersonAcceleration(), which is shared with the
% transition path solver (transpathoptions.GEnewprice=2).
%

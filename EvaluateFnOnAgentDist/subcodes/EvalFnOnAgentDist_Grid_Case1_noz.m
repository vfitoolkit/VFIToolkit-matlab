...
elseif l_d==3
    if l_a==1
        Values=arrayfun(FnToEvaluate, d1vals,d2vals,d3vals, a1primevals, a1vals, ParamCell{:});
    elseif l_a==2
...
elseif l_d==4
    if l_a==1
        Values=arrayfun(FnToEvaluate, d1vals,d2vals,d3vals,d4vals, a1primevals, a1vals, ParamCell{:});
    elseif l_a==2

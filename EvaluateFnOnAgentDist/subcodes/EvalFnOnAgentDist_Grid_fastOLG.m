...
elseif l_d==2
    ...
    elseif l_a==4
        if l_z==1
            Values=arrayfun(FnToEvaluate, PolicyValues(:,:,:,1),PolicyValues(:,:,:,2),PolicyValues(:,:,:,3),PolicyValues(:,:,:,4),PolicyValues(:,:,:,5),PolicyValues(:,:,:,6), a_gridvals(:,1),a_gridvals(:,2),a_gridvals(:,3),a_gridvals(:,4), z_gridvals(1,1,:,1), ParamCell{:});
        elseif l_z==2
            Values=arrayfun(FnToEvaluate, PolicyValues(:,:,:,1),PolicyValues(:,:,:,2),PolicyValues(:,:,:,3),PolicyValues(:,:,:,4),PolicyValues(:,:,:,5),PolicyValues(:,:,:,6), a_gridvals(:,1),a_gridvals(:,2),a_gridvals(:,3),a_gridvals(:,4), z_gridvals(1,1,:,1),z_gridvals(1,1,:,2), ParamCell{:});
        elseif l_z==3
            Values=arrayfun(FnToEvaluate, PolicyValues(:,:,:,1),PolicyValues(:,:,:,2),PolicyValues(:,:,:,3),PolicyValues(:,:,:,4),PolicyValues(:,:,:,5),PolicyValues(:,:,:,6), a_gridvals(:,1),a_gridvals(:,2),a_gridvals(:,3),a_gridvals(:,4), z_gridvals(1,1,:,1),z_gridvals(1,1,:,2),z_gridvals(1,1,:,3), ParamCell{:});
        elseif l_z==4
            Values=arrayfun(FnToEvaluate, PolicyValues(:,:,:,1),PolicyValues(:,:,:,2),PolicyValues(:,:,:,3),PolicyValues(:,:,:,4),PolicyValues(:,:,:,5),PolicyValues(:,:,:,6), a_gridvals(:,1),a_gridvals(:,2),a_gridvals(:,3),a_gridvals(:,4), z_gridvals(1,1,:,1),z_gridvals(1,1,:,2),z_gridvals(1,1,:,3),z_gridvals(1,1,:,4), ParamCell{:});
        end
    end
elseif l_d==3
    if l_a==1
        if l_z==1
            Values=arrayfun(FnToEvaluate, PolicyValues(:,:,:,1),PolicyValues(:,:,:,2),PolicyValues(:,:,:,3),PolicyValues(:,:,:,4), a_gridvals(:,1), z_gridvals(1,1,:,1), ParamCell{:});
        elseif l_z==2
            Values=arrayfun(FnToEvaluate, PolicyValues(:,:,:,1),PolicyValues(:,:,:,2),PolicyValues(:,:,:,3),PolicyValues(:,:,:,4), a_gridvals(:,1), z_gridvals(1,1,:,1),z_gridvals(1,1,:,2), ParamCell{:});
        elseif l_z==3
            Values=arrayfun(FnToEvaluate, PolicyValues(:,:,:,1),PolicyValues(:,:,:,2),PolicyValues(:,:,:,3),PolicyValues(:,:,:,4), a_gridvals(:,1), z_gridvals(1,1,:,1),z_gridvals(1,1,:,2),z_gridvals(1,1,:,3), ParamCell{:});
        elseif l_z==4
            Values=arrayfun(FnToEvaluate, PolicyValues(:,:,:,1),PolicyValues(:,:,:,2),PolicyValues(:,:,:,3),PolicyValues(:,:,:,4), a_gridvals(:,1), z_gridvals(1,1,:,1),z_gridvals(1,1,:,2),z_gridvals(1,1,:,3),z_gridvals(1,1,:,4), ParamCell{:});
        end
    elseif l_a==2
        if l_z==1
...
elseif l_d==4
    if l_a==1
        if l_z==1
            Values=arrayfun(FnToEvaluate, PolicyValues(:,:,:,1),PolicyValues(:,:,:,2),PolicyValues(:,:,:,3),PolicyValues(:,:,:,4),PolicyValues(:,:,:,5), a_gridvals(:,1), z_gridvals(1,1,:,1), ParamCell{:});
        elseif l_z==2
            Values=arrayfun(FnToEvaluate, PolicyValues(:,:,:,1),PolicyValues(:,:,:,2),PolicyValues(:,:,:,3),PolicyValues(:,:,:,4),PolicyValues(:,:,:,5), a_gridvals(:,1), z_gridvals(1,1,:,1),z_gridvals(1,1,:,2), ParamCell{:});
        elseif l_z==3
            Values=arrayfun(FnToEvaluate, PolicyValues(:,:,:,1),PolicyValues(:,:,:,2),PolicyValues(:,:,:,3),PolicyValues(:,:,:,4),PolicyValues(:,:,:,5), a_gridvals(:,1), z_gridvals(1,1,:,1),z_gridvals(1,1,:,2),z_gridvals(1,1,:,3), ParamCell{:});
        elseif l_z==4
            Values=arrayfun(FnToEvaluate, PolicyValues(:,:,:,1),PolicyValues(:,:,:,2),PolicyValues(:,:,:,3),PolicyValues(:,:,:,4),PolicyValues(:,:,:,5), a_gridvals(:,1), z_gridvals(1,1,:,1),z_gridvals(1,1,:,2),z_gridvals(1,1,:,3),z_gridvals(1,1,:,4), ParamCell{:});
        end
    elseif l_a==2
        if l_z==1

...
% joint z_grid
if l_z>=1
    z1vals=shiftdim(z_gridvals(:,1),-l_a);
    if l_z>=2
        z2vals=shiftdim(z_gridvals(:,2),-l_a);
        if l_z>=3
            z3vals=shiftdim(z_gridvals(:,3),-l_a);
            if l_z>=4
                z4vals=shiftdim(z_gridvals(:,4),-l_a);
                if l_z>=5
                    z5vals=shiftdim(z_gridvals(:,5),-l_a);
                end
            end
        end
    end
...
elseif l_d==3
    if l_a==1
        if l_z==1
            Values=arrayfun(FnToEvaluate, d1vals,d2vals,d3vals, a1primevals, a1vals, z1vals, ParamCell{:});
        elseif l_z==2
            Values=arrayfun(FnToEvaluate, d1vals,d2vals,d3vals, a1primevals, a1vals, z1vals,z2vals, ParamCell{:});
        elseif l_z==3
            Values=arrayfun(FnToEvaluate, d1vals,d2vals,d3vals, a1primevals, a1vals, z1vals,z2vals,z3vals, ParamCell{:});
        elseif l_z==4
            Values=arrayfun(FnToEvaluate, d1vals,d2vals,d3vals, a1primevals, a1vals, z1vals,z2vals,z3vals,z4vals, ParamCell{:});
        end
    elseif l_a==2
        if l_z==1
...
elseif l_d==4
    if l_a==1
        if l_z==1
            Values=arrayfun(FnToEvaluate, d1vals,d2vals,d3vals,d4vals, a1primevals, a1vals, z1vals, ParamCell{:});
        elseif l_z==2
            Values=arrayfun(FnToEvaluate, d1vals,d2vals,d3vals,d4vals, a1primevals, a1vals, z1vals,z2vals, ParamCell{:});
        elseif l_z==3
            Values=arrayfun(FnToEvaluate, d1vals,d2vals,d3vals,d4vals, a1primevals, a1vals, z1vals,z2vals,z3vals, ParamCell{:});
        elseif l_z==4
            Values=arrayfun(FnToEvaluate, d1vals,d2vals,d3vals,d4vals, a1primevals, a1vals, z1vals,z2vals,z3vals,z4vals, ParamCell{:});
        end
    elseif l_a==2
        if l_z==1

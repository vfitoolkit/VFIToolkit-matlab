function ValuesOnGrid=EvalFnOnAgentDist_ValuesOnGrid_FHorz_Case3_PType(StationaryDist, Policy, FnsToEvaluate, Parameters,n_d,n_a,n_z,N_j,Names_i,d_grid, a_grid, z_grid, simoptions)
...
ValuesOnGrid=EvalFnOnAgentDist_ValuesOnGrid_FHorz_Case2_PType(StationaryDist, Policy, FnsToEvaluate, Parameters, n_d, n_a, n_z, N_j, Names_i, d_grid, a_grid, z_grid, simoptions);

...
if N_z==0
    if simoptions.lowmemory==0
        ...
        for ff=1:length(FnsToEvaluate)
            ...
            ValuesOnGrid.(AggVarNames{ff})=EvalFnOnAgentDist_Grid_J(FnsToEvaluate{ff},ParamCell,PolicyValuesPermute,l_daprime,n_a,0,a_gridvals,[]);
        end
    ...
    elseif simoptions.lowmemory==1 % Loop over age j
        ...
        for ff=1:length(FnsToEvaluate)
            ...
            ValuesOnGrid.(AggVarNames{ff})=Values;
        end
    end
    ...
    if simoptions.lowmemory==0
        ...
        for ff=1:length(FnsToEvaluate)
            ...
            ValuesOnGrid.(AggVarNames{ff})=EvalFnOnAgentDist_Grid_J(FnsToEvaluate{ff},ParamCell,PolicyValuesPermute,l_daprime,n_a,n_z,a_gridvals,z_gridvals_J);
        end

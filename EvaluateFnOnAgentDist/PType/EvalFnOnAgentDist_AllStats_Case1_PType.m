function AllStats=EvalFnOnAgentDist_AllStats_Case1_PType(StationaryDist, Policy, FnsToEvaluate, Parameters,n_d,n_a,n_z,Names_i,d_grid, a_grid, z_grid, simoptions)
...
for ii=1:N_i
    ...
    for kk=1:numFnsToEvaluate % Each of the functions to be evaluated on the grid
        if FnsAndPTypeIndicator_ii(kk)==1 % If this function is relevant to this ptype
            ...
            ValuesOnGrid_ii=EvalFnOnAgentDist_ValuesOnGrid_subfn(PolicyValues_temp, FnsToEvaluate_iikk, Parameters_temp, [], n_d_temp, n_a_temp, n_z_temp, a_grid_temp, z_grid_temp, simoptions_temp);

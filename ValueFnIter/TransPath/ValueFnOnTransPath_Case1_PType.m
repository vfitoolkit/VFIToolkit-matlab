function [VPath,PolicyPath]=ValueFnOnTransPath_Case1_PType(PricePath, ParamPath, T, V_final, Policy_final, Parameters, n_d, n_a, n_z, Names_i, pi_z, d_grid, a_grid,z_grid, DiscountFactorParamNames, ReturnFn, vfoptions)
...
for ii=1:N_i
    ...
    [VPath_ii,PolicyPath_ii]=ValueFnOnTransPath_Case1(PricePath, ParamPath_temp, T, V_final_temp, Policy_final_temp, Parameters_temp, n_d_temp, n_a_temp, n_z_temp, pi_z_temp, d_grid_temp, a_grid_temp,z_grid_temp, DiscountFactorParamNames_temp, ReturnFn_temp, transpathoptions_temp, vfoptions_temp);

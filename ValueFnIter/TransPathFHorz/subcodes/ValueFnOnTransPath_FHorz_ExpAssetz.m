...
n_a2=n_a(end); % n_a2 is the experienceassetz
...
if prod(n_a1)==0
    error('Not yet implemented transpath with experienceassetz, without a standard endogenous state')
end
...
l_daprime=length(n_d)+length(n_a)-1; % remove experienceassetz from l_aprime

function [VKron,Policy]=ValueFnIter_InfHorz_Refine_preGI2B_HowardMix_raw(VKron,n_d,n_a,n_z,d_gridvals,a_grid,z_gridvals,pi_z,ReturnFn,DiscountFactorParamsVec,ReturnFnParams,vfoptions)

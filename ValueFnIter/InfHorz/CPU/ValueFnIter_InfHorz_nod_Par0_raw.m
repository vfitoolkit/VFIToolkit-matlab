function [VKron, Policy]=ValueFnIter_InfHorz_nod_Par0_raw(VKron, N_a, N_z, pi_z, DiscountFactorParamsVec, ReturnMatrix, Howards,Howards2,Tolerance,maxiter) % Verbose

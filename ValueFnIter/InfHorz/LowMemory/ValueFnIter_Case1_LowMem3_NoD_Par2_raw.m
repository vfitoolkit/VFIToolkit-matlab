function [VKron, Policy]=ValueFnIter_Case1_LowMem3_NoD_Par2_raw(VKron, n_a, n_z, a_grid, z_grid, pi_z, beta, ReturnFn, ReturnFnParams, Howards,Howards2,Tolerance,lowmemorydimensions) % Verbose, ReturnFnParamNames, 
%Does pretty much exactly the same as ValueFnIter_Case1, only without any decision variable (n_d=0)

n_z1=n_z(setdiff(1:1:N_z,lowmemorydimensions));
n_z2=n_z(lowmemorydimensions);

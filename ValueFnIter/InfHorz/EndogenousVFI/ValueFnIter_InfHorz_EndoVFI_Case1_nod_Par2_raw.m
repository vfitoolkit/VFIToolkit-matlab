function [VKron, Policy]=ValueFnIter_InfHorz_EndoVFI_Case1_nod_Par2_raw(VKron, n_a, n_z, pi_z, beta, ReturnMatrix, Howards,Howards2,Tolerance) % Verbose, a_grid, z_grid,

function [VKron, Policy]=PolicyFnIter_Case1_Par2_raw(VKron, n_d,n_a,n_z, pi_z, beta, ReturnMatrix, Howards,Howards2, Tolerance) %Verbose,
...
%     tic;
    ...
    optdaprime=ind2sub_vec_homemade([N_d,N_a],PolicyIndexes(:));
    optaprime=optdaprime(:,2)';

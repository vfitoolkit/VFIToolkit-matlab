...
Policy3=zeros(3,N_a,N_e,N_j,'gpuArray'); %first dim indexes the optimal choice for d and a1prime rest of dimensions a,e
...
if vfoptions.lowmemory>0
    ...
    % precompute
    eind=shiftdim((0:1:N_e-1),-3); % already includes -1; for d2aprime e-stride into 5D DiscountedEV
    % Preallocate

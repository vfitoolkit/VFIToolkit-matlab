function [V, Policy]=ValueFnIter_Case1_FHorz_ExogShock_no_d_raw(n_a,n_z,N_j, a_grid, z_grid,pi_z, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
% THIS CODE IS NOT CURRENTLY USED BY ANYTHING IN TOOLKIT. (implemented
% ExogShockFn directly in the standard FHorz codes instead of here as a seperate command)

...
if ~isfield(vfoptions,'V_Jplus1')
    ReturnMatrix=CreateReturnFnMatrix_Disc_DC2B_nod(ReturnFn,n_e, a1_grid, a2_grid, a1_grid, a2_grid, e_gridvals_J(:,:,N_j), ReturnFnParamsVec,1);
...
for reverse_j=1:N_j-1
    ...
    ReturnMatrix=CreateReturnFnMatrix_Disc_DC2B_nod(ReturnFn, n_e, a1_grid, a2_grid, a1_grid, a2_grid, e_gridvals_J(:,:,jj), ReturnFnParamsVec,1);
    entireRHS=ReturnMatrix+DiscountFactorParamsVec*EV;

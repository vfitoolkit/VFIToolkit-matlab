...
if ~isfield(vfoptions,'V_Jplus1')
    ReturnMatrix=CreateReturnFnMatrix_Disc_DC2B_e(ReturnFn,n_d,n_z,n_e,d_gridvals,a1_grid, a2_grid, a1_grid, a2_grid, z_gridvals_J(:,:,N_j),e_gridvals_J(:,:,N_j), ReturnFnParamsVec,1,0);
...
for reverse_j=1:N_j-1
    ...
    ReturnMatrix=CreateReturnFnMatrix_Disc_DC2B_e(ReturnFn,n_d,n_z,n_e,d_gridvals, a1_grid, a2_grid, a1_grid, a2_grid, z_gridvals_J(:,:,jj),e_gridvals_J(:,:,jj), ReturnFnParamsVec,1,0);
    entireRHS=ReturnMatrix+DiscountFactorParamsVec*shiftdim(EV,-1);

...
if ~isfield(vfoptions,'V_Jplus1')
    if vfoptions.lowmemory==0
        ...
        for ii=1:(vfoptions.level1n-1)
            ...
            if maxgap(ii)>0
                ...
                ReturnMatrix_ii_inner=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, 0, n_d2, n_a2, n_z, n_e, d2_gridvals, a1_grid(a1primeindexes), a2_gridvals, a1_grid(level1ii(ii)+1:level1ii(ii+1)-1), a2_gridvals, a3_grid, z_gridvals_J(:,:,N_j), e_gridvals_J(:,:,N_j), ReturnFnParamsVec, 3);
        ...
        ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, 0, n_d2, n_a2, n_z, n_e, d2_gridvals, a1prime_grid(a1primeindexesfine), a2_gridvals, a1_grid, a2_gridvals, a3_grid, z_gridvals_J(:,:,N_j), e_gridvals_J(:,:,N_j), ReturnFnParamsVec, 2);
        ...
        for z_c=1:N_z
            ...
            for ii=1:(vfoptions.level1n-1)
                ...
                if maxgap(ii)>0
                    ...
                    a1primeindexes=loweredge+(0:1:maxgap(ii));
                    ReturnMatrix_ii_inner_z=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, 0, n_d2, n_a2, special_n_z, n_e, d2_gridvals, a1_grid(a1primeindexes), a2_gridvals, a1_grid(level1ii(ii)+1:level1ii(ii+1)-1), a2_gridvals, a3_grid, z_val, e_gridvals_J(:,:,N_j), ReturnFnParamsVec, 3);
            ...
            ReturnMatrix_ii_z=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, 0, n_d2, n_a2, special_n_z, n_e, d2_gridvals, a1prime_grid(a1primeindexesfine_z), a2_gridvals, a1_grid, a2_gridvals, a3_grid, z_val, e_gridvals_J(:,:,N_j), ReturnFnParamsVec, 2);
            ...
            for e_c=1:N_e
                ...
                for ii=1:(vfoptions.level1n-1)
                    ...
                    if maxgap(ii)>0
                        ...
                        a1primeindexes=loweredge+(0:1:maxgap(ii));
                        ReturnMatrix_ii_inner_ze=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, 0, n_d2, n_a2, special_n_z, special_n_e, d2_gridvals, a1_grid(a1primeindexes), a2_gridvals, a1_grid(level1ii(ii)+1:level1ii(ii+1)-1), a2_gridvals, a3_grid, z_val, e_val, ReturnFnParamsVec, 3);
                ...
                ReturnMatrix_ii_ze=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, 0, n_d2, n_a2, special_n_z, special_n_e, d2_gridvals, a1prime_grid(a1primeindexesfine_ze), a2_gridvals, a1_grid, a2_gridvals, a3_grid, z_val, e_val, ReturnFnParamsVec, 2);
    ...
    [Valt(:,:,:,N_j),Policyalt(:,:,:,:,N_j),PolicyaltL2flag(:,:,:,:,N_j),Vtilde(:,:,:,N_j),Policy(:,:,:,:,N_j),PolicyL2flag(:,:,:,:,N_j)]=...
        DC_GI_one_step_lm0_N(n_d2,n_a1,n_a2,n_a3,n_z,n_e,N_a1,N_a2,N_a3,N_a,N_d2,N_z,N_e,N_a1fine,n2short,n2long,level1ii,level1iidiff, ...
            ReturnFn,d2_gridvals,a1_grid,a2_gridvals,a3_grid,a1prime_grid,z_gridvals_J(:,:,N_j),e_gridvals_J(:,:,N_j),ReturnFnParamsVec, ...
            DiscountedEV_alt,DiscountedEV,DiscountedEVinterp_alt,DiscountedEVinterp,midpoint,midpoint_alt,aind,zindB,eindB);
end
...
for reverse_j=1:N_j-1
    ...
    if vfoptions.lowmemory==0
        [Valt(:,:,:,jj),Policyalt(:,:,:,:,jj),PolicyaltL2flag(:,:,:,:,jj),Vtilde(:,:,:,jj),Policy(:,:,:,:,jj),PolicyL2flag(:,:,:,:,jj)]=...
            DC_GI_one_step_lm0_N(n_d2,n_a1,n_a2,n_a3,n_z,n_e,N_a1,N_a2,N_a3,N_a,N_d2,N_z,N_e,N_a1fine,n2short,n2long,level1ii,level1iidiff, ...
                ReturnFn,d2_gridvals,a1_grid,a2_gridvals,a3_grid,a1prime_grid,z_gridvals_J(:,:,jj),e_gridvals_J(:,:,jj),ReturnFnParamsVec, ...
                DiscountedEV_alt,DiscountedEV,DiscountedEVinterp_alt,DiscountedEVinterp,midpoint,midpoint_alt,aind,zindB,eindB);
    elseif vfoptions.lowmemory==1
        for z_c=1:N_z
            ...
            [Valt(:,z_c,:,jj),Policyalt(:,:,z_c,:,jj),PolicyaltL2flag(:,:,z_c,:,jj),Vtilde(:,z_c,:,jj),Policy(:,:,z_c,:,jj),PolicyL2flag(:,:,z_c,:,jj)]=...
                DC_GI_one_step_lm1_N(n_d2,n_a1,n_a2,n_a3,special_n_z,n_e,N_a1,N_a2,N_a3,N_a,N_d2,N_e,N_a1fine,n2short,n2long,level1ii,level1iidiff, ...
                    ReturnFn,d2_gridvals,a1_grid,a2_gridvals,a3_grid,a1prime_grid,z_val,e_gridvals_J(:,:,jj),ReturnFnParamsVec, ...
                    DiscountedEV_alt_z,DiscountedEV_z,DiscountedEVinterp_alt_z,DiscountedEVinterp_z,midpoint_z,midpoint_alt_z,aind,eindB);
        end
    elseif vfoptions.lowmemory==2
        for z_c=1:N_z
            z_val=z_gridvals_J(z_c,:,jj);
            for e_c=1:N_e
                ...
                [Valt(:,z_c,e_c,jj),Policyalt(:,:,z_c,e_c,jj),PolicyaltL2flag(:,:,z_c,e_c,jj),Vtilde(:,z_c,e_c,jj),Policy(:,:,z_c,e_c,jj),PolicyL2flag(:,:,z_c,e_c,jj)]=...
                    DC_GI_one_step_lm2_N(n_d2,n_a1,n_a2,n_a3,special_n_z,special_n_e,N_a1,N_a2,N_a3,N_a,N_d2,N_a1fine,n2short,n2long,level1ii,level1iidiff, ...
                        ReturnFn,d2_gridvals,a1_grid,a2_gridvals,a3_grid,a1prime_grid,z_val,e_val,ReturnFnParamsVec, ...
                        DiscountedEV_alt_ze,DiscountedEV_ze,DiscountedEVinterp_alt_ze,DiscountedEVinterp_ze,midpoint_ze,midpoint_alt_ze,aind);
            end
        end
    end
end
...
%% ============================================================
%% Inner helpers: DC coarse + GI fine pass (one full backward step)
%% ============================================================

function [Valt_jj,Policyalt_jj,PolicyaltL2flag_jj,Vtilde_jj,Policy_jj,PolicyL2flag_jj]=DC_GI_one_step_lm0_N(n_d2,n_a1,n_a2,n_a3,n_z,n_e,N_a1,N_a2,N_a3,N_a,N_d2,N_z,N_e,N_a1fine,n2short,n2long,level1ii,level1iidiff,ReturnFn,d2_gridvals,a1_grid,a2_gridvals,a3_grid,a1prime_grid,z_gridvals_jj,e_gridvals_jj,ReturnFnParamsVec,DiscountedEV_alt,DiscountedEV,DiscountedEVinterp_alt,DiscountedEVinterp,midpoint,midpoint_alt,aind,zindB,eindB)
ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, 0, n_d2, n_a2, n_z, n_e, d2_gridvals, a1_grid, a2_gridvals, a1_grid(level1ii), a2_gridvals, a3_grid, z_gridvals_jj, e_gridvals_jj, ReturnFnParamsVec, 1);
...
for ii=1:length(level1iidiff)
    ...
    if maxgap_alt(ii)>0
        ...
        ReturnMatrix_inner=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, 0, n_d2, n_a2, n_z, n_e, d2_gridvals, a1_grid(a1primeindexes), a2_gridvals, a1_grid(level1ii(ii)+1:level1ii(ii+1)-1), a2_gridvals, a3_grid, z_gridvals_jj, e_gridvals_jj, ReturnFnParamsVec, 3);
...
ReturnMatrix_ii_alt=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, 0, n_d2, n_a2, n_z, n_e, d2_gridvals, a1prime_grid(a1primeindexesfine_alt), a2_gridvals, a1_grid, a2_gridvals, a3_grid, z_gridvals_jj, e_gridvals_jj, ReturnFnParamsVec, 3);
...
midpoint=max(min(midpoint,N_a1-1),2);
a1primeindexesfine=(midpoint+(midpoint-1)*n2short)+(-n2short-1:1:1+n2short);
ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, 0, n_d2, n_a2, n_z, n_e, d2_gridvals, a1prime_grid(a1primeindexesfine), a2_gridvals, a1_grid, a2_gridvals, a3_grid, z_gridvals_jj, e_gridvals_jj, ReturnFnParamsVec, 3);
...
function [Valt_jj,Policyalt_jj,PolicyaltL2flag_jj,Vtilde_jj,Policy_jj,PolicyL2flag_jj]=DC_GI_one_step_lm1_N(n_d2,n_a1,n_a2,n_a3,special_n_z,n_e,N_a1,N_a2,N_a3,N_a,N_d2,N_e,N_a1fine,n2short,n2long,level1ii,level1iidiff,ReturnFn,d2_gridvals,a1_grid,a2_gridvals,a3_grid,a1prime_grid,z_val,e_gridvals_jj,ReturnFnParamsVec,DiscountedEV_alt_z,DiscountedEV_z,DiscountedEVinterp_alt_z,DiscountedEVinterp_z,midpoint_z,midpoint_alt_z,aind,eindB)
ReturnMatrix_ii_z=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, 0, n_d2, n_a2, special_n_z, n_e, d2_gridvals, a1_grid, a2_gridvals, a1_grid(level1ii), a2_gridvals, a3_grid, z_val, e_gridvals_jj, ReturnFnParamsVec, 1);
...
for ii=1:length(level1iidiff)
    ...
    if maxgap_alt(ii)>0
        ...
        a1primeindexes=loweredge+(0:1:maxgap_alt(ii));
        ReturnMatrix_inner_z=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, 0, n_d2, n_a2, special_n_z, n_e, d2_gridvals, a1_grid(a1primeindexes), a2_gridvals, a1_grid(level1ii(ii)+1:level1ii(ii+1)-1), a2_gridvals, a3_grid, z_val, e_gridvals_jj, ReturnFnParamsVec, 3);
...
ReturnMatrix_ii_alt_z=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, 0, n_d2, n_a2, special_n_z, n_e, d2_gridvals, a1prime_grid(a1primeindexesfine_alt), a2_gridvals, a1_grid, a2_gridvals, a3_grid, z_val, e_gridvals_jj, ReturnFnParamsVec, 3);
...
ReturnMatrix_ii_z=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, 0, n_d2, n_a2, special_n_z, n_e, d2_gridvals, a1prime_grid(a1primeindexesfine), a2_gridvals, a1_grid, a2_gridvals, a3_grid, z_val, e_gridvals_jj, ReturnFnParamsVec, 3);
...
function [Valt_jj,Policyalt_jj,PolicyaltL2flag_jj,Vtilde_jj,Policy_jj,PolicyL2flag_jj]=DC_GI_one_step_lm2_N(n_d2,n_a1,n_a2,n_a3,special_n_z,special_n_e,N_a1,N_a2,N_a3,N_a,N_d2,N_a1fine,n2short,n2long,level1ii,level1iidiff,ReturnFn,d2_gridvals,a1_grid,a2_gridvals,a3_grid,a1prime_grid,z_val,e_val,ReturnFnParamsVec,DiscountedEV_alt_ze,DiscountedEV_ze,DiscountedEVinterp_alt_ze,DiscountedEVinterp_ze,midpoint_ze,midpoint_alt_ze,aind)
ReturnMatrix_ii_ze=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, 0, n_d2, n_a2, special_n_z, special_n_e, d2_gridvals, a1_grid, a2_gridvals, a1_grid(level1ii), a2_gridvals, a3_grid, z_val, e_val, ReturnFnParamsVec, 1);
...
for ii=1:length(level1iidiff)
    ...
    if maxgap_alt(ii)>0
        ...
        a1primeindexes=loweredge+(0:1:maxgap_alt(ii));
        ReturnMatrix_inner_ze=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, 0, n_d2, n_a2, special_n_z, special_n_e, d2_gridvals, a1_grid(a1primeindexes), a2_gridvals, a1_grid(level1ii(ii)+1:level1ii(ii+1)-1), a2_gridvals, a3_grid, z_val, e_val, ReturnFnParamsVec, 3);
...
ReturnMatrix_ii_alt_ze=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, 0, n_d2, n_a2, special_n_z, special_n_e, d2_gridvals, a1prime_grid(a1primeindexesfine_alt), a2_gridvals, a1_grid, a2_gridvals, a3_grid, z_val, e_val, ReturnFnParamsVec, 3);
...
ReturnMatrix_ii_ze=CreateReturnFnMatrix_ExpAsset_Disc_DC2A_e(ReturnFn, 0, n_d2, n_a2, special_n_z, special_n_e, d2_gridvals, a1prime_grid(a1primeindexesfine), a2_gridvals, a1_grid, a2_gridvals, a3_grid, z_val, e_val, ReturnFnParamsVec, 3);

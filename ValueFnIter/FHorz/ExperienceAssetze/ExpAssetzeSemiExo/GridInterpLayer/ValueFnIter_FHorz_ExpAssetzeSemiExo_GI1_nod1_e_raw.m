...
Policy4=zeros(4,N_a,N_bothz,N_e,N_j,'gpuArray'); % (d2, d3, midpoint, L2ind)
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    Policy4(1,:,:,:,N_j)=reshape(Policy3_ford3_jj(1+temp),[1,N_a,N_bothz,N_e]); % d2
    Policy4(3,:,:,:,N_j)=reshape(Policy3_ford3_jj(2+temp),[1,N_a,N_bothz,N_e]); % midpoint
    Policy4(4,:,:,:,N_j)=reshape(Policy3_ford3_jj(3+temp),[1,N_a,N_bothz,N_e]); % L2ind

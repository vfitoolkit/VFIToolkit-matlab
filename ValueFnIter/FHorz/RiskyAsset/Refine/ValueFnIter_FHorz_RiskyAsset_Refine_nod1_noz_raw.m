function [V,Policy]=ValueFnIter_FHorz_RiskyAsset_Refine_nod1_noz_raw(n_d2,n_d3,n_a1,n_a2,n_u, N_j, d2_grid, d3_grid, a1_grid,a2_grid, u_grid, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    ReturnMatrix=CreateReturnFnMatrix_Case2_Disc_noz_Par2(ReturnFn, [n_d3,n_a1], [n_a1,n_a2], [d3_grid; a1_grid], [a1_grid; a2_grid], ReturnFnParamsVec);

...
% Handles vfoptions.divideandconquer==0, vfoptions.gridinterplayer==1 (Plain GI) with semiz, with Epstein-Zin preferences
% Mirrors ValueFnIter_FHorz_RiskyAssetSemiExo_GI, with the Epstein-Zin trailing arguments passed to every raw

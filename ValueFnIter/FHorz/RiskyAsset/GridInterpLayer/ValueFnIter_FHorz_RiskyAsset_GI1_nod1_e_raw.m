...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    elseif vfoptions.lowmemory==2
        for z_c=1:N_z
            ...
            for e_c=1:N_e
                ...
                Policy3(3,:,z_c,e_c,N_j)=ceil(maxindexL2/N_d3);
                L2offset      = ceil(maxindexL2/N_d3);
    ...
    [V(:,:,:,N_j),Policy3(:,:,:,:,N_j),PolicyL2flag(:,:,:,:,N_j),Policyd2(:,:,:,:,N_j)]=internal_per_j_nod1_e(EVpre,a2primeIndex,a2primeProbs,...
        ReturnFn,DiscountFactorParamsVec,ReturnFnParamsVec,...
        n_d3,n_a1,n_a2,n_z,n_e,N_d2,N_d3,N_d23,N_a1,N_a2,N_a,N_z,N_e,N_u,N_a1prime,...
        d3_gridvals,a1_gridvals,a1prime_grid,a2_gridvals,z_gridvals_J(:,:,N_j),e_gridvals_J(:,:,N_j),pi_z_J(:,:,N_j),pi_u_col,...
        aind,zind,zindB,zeindB,a2ind,n2short,n2long,vfoptions);
end
...
for reverse_j=1:N_j-1
    ...
    [V(:,:,:,jj),Policy3(:,:,:,:,jj),PolicyL2flag(:,:,:,:,jj),Policyd2(:,:,:,:,jj)]=internal_per_j_nod1_e(EVnext,a2primeIndex,a2primeProbs,...
        ReturnFn,DiscountFactorParamsVec,ReturnFnParamsVec,...
        n_d3,n_a1,n_a2,n_z,n_e,N_d2,N_d3,N_d23,N_a1,N_a2,N_a,N_z,N_e,N_u,N_a1prime,...
...
%% Per-period inner with e (no d1)
function [V_jj,Policy3_jj,PolicyL2flag_jj,Policyd2_jj]=internal_per_j_nod1_e(EVnext,a2primeIndex,a2primeProbs,...
    ReturnFn,DiscountFactorParamsVec,ReturnFnParamsVec,...
    n_d3,n_a1,n_a2,n_z,n_e,N_d2,N_d3,N_d23,N_a1,N_a2,N_a,N_z,N_e,N_u,N_a1prime,...
...
if vfoptions.lowmemory==0
    ReturnMatrix=CreateReturnFnMatrix_ExpAsset_Disc_e(ReturnFn, 0,n_d3,n_a1,n_a1,n_a2,n_z,n_e, d3_gridvals, a1_gridvals, a1_gridvals, a2_gridvals, z_gridvals, e_gridvals, ReturnFnParamsVec,1,0);
...
elseif vfoptions.lowmemory>=1
    ...
    for e_c=1:N_e
        ...
        ReturnMatrix_e=CreateReturnFnMatrix_ExpAsset_Disc_e(ReturnFn, 0,n_d3,n_a1,n_a1,n_a2,n_z,special_n_e, d3_gridvals, a1_gridvals, a1_gridvals, a2_gridvals, z_gridvals, e_val, ReturnFnParamsVec,1,0);

...
if ~isfield(vfoptions,'V_Jplus1')
    if vfoptions.lowmemory==0
        ...
        allind=d_ind+N_d3*aind+N_d3*N_a*eindB;
        Policy3(1,:,:,N_j)=d_ind;
        ...
        linidx_lower  = d_ind                   + N_d3*n2long*aind + N_d3*n2long*N_a*eindB;
        linidx_upper  = d_ind + N_d3*(n2long-1) + N_d3*n2long*aind + N_d3*n2long*N_a*eindB;
    ...
    elseif vfoptions.lowmemory==1
        for e_c=1:N_e
            ...
            Policy3(3,:,e_c,N_j)=ceil(maxindexL2/N_d3);
            L2offset      = ceil(maxindexL2/N_d3);
    ...
    [V(:,:,N_j),Policy3(:,:,:,N_j),PolicyL2flag(:,:,:,N_j),Policyd2(:,:,:,N_j)]=internal_per_j_nod1_noz_e(EVpre,a2primeIndex,a2primeProbs,...
        ReturnFn,DiscountFactorParamsVec,ReturnFnParamsVec,...
        n_d3,n_a1,n_a2,n_e,N_d2,N_d3,N_d23,N_a1,N_a2,N_a,N_e,N_u,N_a1prime,...
...
for reverse_j=1:N_j-1
    ...
    [V(:,:,jj),Policy3(:,:,:,jj),PolicyL2flag(:,:,:,jj),Policyd2(:,:,:,jj)]=internal_per_j_nod1_noz_e(EVnext,a2primeIndex,a2primeProbs,...
        ReturnFn,DiscountFactorParamsVec,ReturnFnParamsVec,...
        n_d3,n_a1,n_a2,n_e,N_d2,N_d3,N_d23,N_a1,N_a2,N_a,N_e,N_u,N_a1prime,...
...
%% Per-period inner (nod1, noz, with e)
function [V_jj,Policy3_jj,PolicyL2flag_jj,Policyd2_jj]=internal_per_j_nod1_noz_e(EVnext,a2primeIndex,a2primeProbs,...
    ReturnFn,DiscountFactorParamsVec,ReturnFnParamsVec,...
    n_d3,n_a1,n_a2,n_e,N_d2,N_d3,N_d23,N_a1,N_a2,N_a,N_e,N_u,N_a1prime,...
...
if vfoptions.lowmemory==0
    ReturnMatrix=CreateReturnFnMatrix_ExpAsset_Disc(ReturnFn, 0,n_d3,n_a1,n_a1,n_a2,n_e, d3_gridvals, a1_gridvals, a1_gridvals, a2_gridvals, e_gridvals, ReturnFnParamsVec,1,0); % e in z-slot
    ...
    Policyd2_jj(1,:,:)=reshape(d2index_resh(lin),[1,N_a,N_e]);
...
elseif vfoptions.lowmemory>=1
    ...
    for e_c=1:N_e
        ...
        Policy3_jj(3,:,e_c)=ceil(maxindexL2/N_d3);
        L2offset      = ceil(maxindexL2/N_d3);
        linidx_lower  = d_ind                   + N_d3*n2long*aind;
        linidx_upper  = d_ind + N_d3*(n2long-1) + N_d3*n2long*aind;
        isInfLower    = (ReturnMatrix_ii(linidx_lower) == -Inf);

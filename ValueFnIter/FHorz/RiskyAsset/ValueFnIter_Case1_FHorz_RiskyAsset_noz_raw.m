...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    EV2=(1-aprimeProbs).*reshape(V_Jplus1(aprimeIndex+1),[N_d*N_a1,N_u]); % (d,u), the upper aprime
...
for reverse_j=1:N_j-1
    ...
    EV2=(1-aprimeProbs).*reshape(VKronNext_j(aprimeIndex+1),[N_d*N_a1,N_u]); % (d,u), the upper aprime
    % Already applied the probabilities from interpolating onto grid

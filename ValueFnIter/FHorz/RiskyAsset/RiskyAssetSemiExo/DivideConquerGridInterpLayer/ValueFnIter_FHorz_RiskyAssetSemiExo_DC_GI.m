...
if length(n_a1)>1
    ...
    if length(vfoptions.level1n)>1 % only a1_1 is divide-conquered, so level1n must end up scalar
        if vfoptions.level1n(2)>=n_a1_2
            vfoptions.level1n=vfoptions.level1n(1);
        else
            error('With riskyasset+semiz DC2A_GI2A, can only do divide-and-conquer on the first standard endogenous state')
        end
    end
    ...
    if N_e==0 % no e variable
        if N_d1==0
            if N_z==0
                [VKron, PolicyKron]=ValueFnIter_FHorz_RiskyAssetSemiExo_DC2A_GI2A_nod1_noz_raw(n_d2,n_d3,n_d4,n_a1_1,n_a1_2,n_a2,n_semiz,n_u, N_j, d2_grid, d3_grid, d4_grid, a1_1_grid, a1_2_grid, a2_grid, semiz_gridvals_J, u_grid, pi_semiz_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions);
            else
                [VKron, PolicyKron]=ValueFnIter_FHorz_RiskyAssetSemiExo_DC2A_GI2A_nod1_raw(n_d2,n_d3,n_d4,n_a1_1,n_a1_2,n_a2,n_semiz,n_z,n_u, N_j, d2_grid, d3_grid, d4_grid, a1_1_grid, a1_2_grid, a2_grid, semiz_gridvals_J, z_gridvals_J, u_grid, pi_semiz_J, pi_z_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions);
            end
        else
            if N_z==0
                [VKron, PolicyKron]=ValueFnIter_FHorz_RiskyAssetSemiExo_DC2A_GI2A_noz_raw(n_d1,n_d2,n_d3,n_d4,n_a1_1,n_a1_2,n_a2,n_semiz,n_u, N_j, d1_grid, d2_grid, d3_grid, d4_grid, a1_1_grid, a1_2_grid, a2_grid, semiz_gridvals_J, u_grid, pi_semiz_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions);
            else
                [VKron, PolicyKron]=ValueFnIter_FHorz_RiskyAssetSemiExo_DC2A_GI2A_raw(n_d1,n_d2,n_d3,n_d4,n_a1_1,n_a1_2,n_a2,n_semiz,n_z,n_u, N_j, d1_grid, d2_grid, d3_grid, d4_grid, a1_1_grid, a1_2_grid, a2_grid, semiz_gridvals_J, z_gridvals_J, u_grid, pi_semiz_J, pi_z_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions);
            end
        end
    else % N_e
        if N_d1==0
            if N_z==0
                [VKron, PolicyKron]=ValueFnIter_FHorz_RiskyAssetSemiExo_DC2A_GI2A_nod1_noz_e_raw(n_d2,n_d3,n_d4,n_a1_1,n_a1_2,n_a2,n_semiz,vfoptions.n_e,n_u, N_j, d2_grid, d3_grid, d4_grid, a1_1_grid, a1_2_grid, a2_grid, semiz_gridvals_J, vfoptions.e_gridvals_J, u_grid, pi_semiz_J, vfoptions.pi_e_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions);
            else
                [VKron, PolicyKron]=ValueFnIter_FHorz_RiskyAssetSemiExo_DC2A_GI2A_nod1_e_raw(n_d2,n_d3,n_d4,n_a1_1,n_a1_2,n_a2,n_semiz,n_z,vfoptions.n_e,n_u, N_j, d2_grid, d3_grid, d4_grid, a1_1_grid, a1_2_grid, a2_grid, semiz_gridvals_J, z_gridvals_J, vfoptions.e_gridvals_J, u_grid, pi_semiz_J, pi_z_J, vfoptions.pi_e_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions);
            end
        else % d1 variable
            if N_z==0
                [VKron, PolicyKron]=ValueFnIter_FHorz_RiskyAssetSemiExo_DC2A_GI2A_noz_e_raw(n_d1,n_d2,n_d3,n_d4,n_a1_1,n_a1_2,n_a2,n_semiz,vfoptions.n_e,n_u, N_j, d1_grid, d2_grid, d3_grid, d4_grid, a1_1_grid, a1_2_grid, a2_grid, semiz_gridvals_J, vfoptions.e_gridvals_J, u_grid, pi_semiz_J, vfoptions.pi_e_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions);
            else
                [VKron, PolicyKron]=ValueFnIter_FHorz_RiskyAssetSemiExo_DC2A_GI2A_e_raw(n_d1,n_d2,n_d3,n_d4,n_a1_1,n_a1_2,n_a2,n_semiz,n_z,vfoptions.n_e,n_u, N_j, d1_grid, d2_grid, d3_grid, d4_grid, a1_1_grid, a1_2_grid, a2_grid, semiz_gridvals_J, z_gridvals_J, vfoptions.e_gridvals_J, u_grid, pi_semiz_J, pi_z_J, vfoptions.pi_e_J, pi_u, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions);
            end
        end
    end

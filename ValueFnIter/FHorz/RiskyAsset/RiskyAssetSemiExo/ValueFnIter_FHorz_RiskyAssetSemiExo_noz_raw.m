...
Policy5=zeros(5,N_a,N_semiz,N_j,'gpuArray'); % d1, d2, d3, d4, a1prime
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    if vfoptions.lowmemory==0
        ...
        Policy5(2,:,:,N_j)=shiftdim(d2index_ford4_jj(d3a1prime_ind+N_d3*N_a1*semizind+N_d3*N_a1*N_semiz*shiftdim(maxindex-1,-1)),-1);
...
for reverse_j=1:N_j-1
    ...
    if vfoptions.lowmemory==0
        ...
        Policy5(2,:,:,jj)=shiftdim(d2index_ford4_jj(d3a1prime_ind+N_d3*N_a1*semizind+N_d3*N_a1*N_semiz*shiftdim(maxindex-1,-1)),-1);
        d1_lookup=d3a1prime_ind+N_d3*N_a1*shiftdim(aind,-1)+N_d3*N_a1*N_a*semizind+N_d3*N_a1*N_a*N_semiz*shiftdim(maxindex-1,-1);

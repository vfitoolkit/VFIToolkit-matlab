...
if ~isfield(vfoptions,'V_Jplus1')
    if vfoptions.lowmemory==0
        midpoint=zeros(N_d13,1,N_a1,N_a2,N_e,'gpuArray');
        ...
        allind=d_ind+N_d13*aind+N_d13*N_a*eBind;
        Policy3(1,:,:,N_j)=d_ind;
        ...
        linidx_lower  = d_ind                    + N_d13*n2long*aind + N_d13*n2long*N_a*eBind;
        linidx_upper  = d_ind + N_d13*(n2long-1) + N_d13*n2long*aind + N_d13*n2long*N_a*eBind;
    ...
    [V(:,:,N_j),Policy3(:,:,:,N_j),PolicyL2flag(:,:,:,N_j),d2Policy(:,:,:,N_j)]=internal_per_j_noz_e(EVpre,a2primeIndex,a2primeProbs,ReturnFn,DiscountFactorParamsVec,ReturnFnParamsVec,...
        n_d1,n_d3,n_a1,n_a2,n_e,N_d1,N_d2,N_d3,N_d13,N_d23,N_a1,N_a1prime,N_a2,N_a,N_e,N_u,...
...
for reverse_j=1:N_j-1
    ...
    [V(:,:,jj),Policy3(:,:,:,jj),PolicyL2flag(:,:,:,jj),d2Policy(:,:,:,jj)]=internal_per_j_noz_e(EVnext,a2primeIndex,a2primeProbs,ReturnFn,DiscountFactorParamsVec,ReturnFnParamsVec,...
        n_d1,n_d3,n_a1,n_a2,n_e,N_d1,N_d2,N_d3,N_d13,N_d23,N_a1,N_a1prime,N_a2,N_a,N_e,N_u,...
...
%% Encode single-index Policy (d1, noz, e)
...
function [V_jj,Policy3_jj,PolicyL2flag_jj,d2Policy_jj]=internal_per_j_noz_e(EVnext,a2primeIndex,a2primeProbs,ReturnFn,DiscountFactorParamsVec,ReturnFnParamsVec,...
    n_d1,n_d3,n_a1,n_a2,n_e,N_d1,N_d2,N_d3,N_d13,N_d23,N_a1,N_a1prime,N_a2,N_a,N_e,N_u,...
...
if vfoptions.lowmemory==0
    ...
    midpoint=max(min(midpoint,n_a1(1)-1),2);
    a1primeindexesfine=(midpoint+(midpoint-1)*n2short)+(-n2short-1:1:1+n2short);
    ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc(ReturnFn, n_d1,n_d3,n2long,n_a1,n_a2,n_e, d13_gridvals, a1prime_grid(a1primeindexesfine), a1_gridvals, a2_gridvals, e_gridvals, ReturnFnParamsVec,2,0);
    da1prime=d3ind+N_d3*(a1primeindexesfine-1); % [N_d13,n2long,N_a1,N_a2,N_e]; index into DiscountedEVinterp [N_d3,N_a1prime,1,1]
    ...
    d3part=rem(ceil(shiftdim(d_ind,1)/N_d1)-1,N_d3)+1; % [N_a,N_e]

...
d2Policy=ones(1,N_a,N_e,N_j,'gpuArray');
...
if ~isfield(vfoptions,'V_Jplus1')
    if vfoptions.lowmemory==0
        midpoint=zeros(N_d3,1,N_a1,N_a2,N_e,'gpuArray');
        ...
        allind=d_ind+N_d3*aind+N_d3*N_a*eBind;
        Policy3(1,:,:,N_j)=d_ind;
        ...
        linidx_lower  = d_ind                   + N_d3*n2long*aind + N_d3*n2long*N_a*eBind;
        linidx_upper  = d_ind + N_d3*(n2long-1) + N_d3*n2long*aind + N_d3*n2long*N_a*eBind;
    ...
    EVpre=sum(V_Jplus1.*shiftdim(pi_e_J(:,N_j),-1),2);
    aprimeFnParamsVec=CreateVectorFromParams(Parameters, aprimeFnParamNames,N_j);
    [a2primeIndex,a2primeProbs]=CreateRiskyAssetFnMatrix(aprimeFn, n_d23, n_a2, n_u, d23_grid, a2_grid, u_grid, aprimeFnParamsVec,2);
    [V(:,:,N_j),Policy3(:,:,:,N_j),PolicyL2flag(:,:,:,N_j),d2Policy(:,:,:,N_j)]=internal_per_j_nod1_noz_e(EVpre,a2primeIndex,a2primeProbs,ReturnFn,DiscountFactorParamsVec,ReturnFnParamsVec,...
        n_d3,n_a1,n_a2,n_e,N_d2,N_d3,N_d23,N_a1,N_a1prime,N_a2,N_a,N_e,N_u,...
        d3_gridvals,a1_gridvals,a1prime_grid,a2_gridvals,e_gridvals_J(:,:,N_j),pi_u_col,...
        level1ii,level1iidiff,n2short,n2long,aind,a2ind,a2Bind,eBind,d3ind,vfoptions);
end
...
for reverse_j=1:N_j-1
    ...
    [V(:,:,jj),Policy3(:,:,:,jj),PolicyL2flag(:,:,:,jj),d2Policy(:,:,:,jj)]=internal_per_j_nod1_noz_e(EVnext,a2primeIndex,a2primeProbs,ReturnFn,DiscountFactorParamsVec,ReturnFnParamsVec,...
        n_d3,n_a1,n_a2,n_e,N_d2,N_d3,N_d23,N_a1,N_a1prime,N_a2,N_a,N_e,N_u,...
        d3_gridvals,a1_gridvals,a1prime_grid,a2_gridvals,e_gridvals_J(:,:,jj),pi_u_col,...
        level1ii,level1iidiff,n2short,n2long,aind,a2ind,a2Bind,eBind,d3ind,vfoptions);
end
...
%% Encode single-index Policy (no d1, no z, e)
N_d=N_d2*N_d3;
...
function [V_jj,Policy3_jj,PolicyL2flag_jj,d2Policy_jj]=internal_per_j_nod1_noz_e(EVnext,a2primeIndex,a2primeProbs,ReturnFn,DiscountFactorParamsVec,ReturnFnParamsVec,...
    n_d3,n_a1,n_a2,n_e,N_d2,N_d3,N_d23,N_a1,N_a1prime,N_a2,N_a,N_e,N_u,...
    d3_gridvals,a1_gridvals,a1prime_grid,a2_gridvals,e_gridvals,pi_u_col,...
    level1ii,level1iidiff,n2short,n2long,aind,a2ind,a2Bind,eBind,d3ind,vfoptions)

V_jj=zeros(N_a,N_e,'gpuArray');
Policy3_jj=zeros(3,N_a,N_e,'gpuArray');
PolicyL2flag_jj=2*ones(1,N_a,N_e,'gpuArray');
d2Policy_jj=ones(1,N_a,N_e,'gpuArray');
...
if vfoptions.lowmemory==0
    ...
    midpoint=max(min(midpoint,n_a1(1)-1),2);
    a1primeindexesfine=(midpoint+(midpoint-1)*n2short)+(-n2short-1:1:1+n2short);
    ReturnMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc(ReturnFn, 0,n_d3,n2long,n_a1,n_a2,n_e, d3_gridvals, a1prime_grid(a1primeindexesfine), a1_gridvals, a2_gridvals, e_gridvals, ReturnFnParamsVec,2,0);
    ...
    d3part=shiftdim(d_ind,1); % [N_a,N_e]

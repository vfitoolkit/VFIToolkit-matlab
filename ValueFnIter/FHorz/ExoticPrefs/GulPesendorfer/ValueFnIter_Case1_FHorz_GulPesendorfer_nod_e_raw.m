function [V, Policy]=ValueFnIter_Case1_FHorz_GulPesendorfer_nod_e_raw(n_a,n_z,n_e,N_j, a_grid, z_grid, e_grid, pi_z, pi_e, ReturnFn, TemptationFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, TemptationFnParamNames, vfoptions)
...
if ~isfield(vfoptions,'V_Jplus1')
    if vfoptions.lowmemory==0
        ...
        TemptationMatrix=CreateReturnFnMatrix_Case1_Disc_Par2e(TemptationFn, 0, n_a, n_z, n_e, 0, a_grid, z_grid, e_grid, TemptationFnParamsVec);
    ...
    elseif vfoptions.lowmemory==1
        ...
        for e_c=1:N_e
            ...
            TemptationMatrix_e=CreateReturnFnMatrix_Case1_Disc_Par2e(TemptationFn, 0, n_a, n_z, special_n_e, 0, a_grid, z_grid, e_val, TemptationFnParamsVec);

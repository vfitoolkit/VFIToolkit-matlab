function [V1,Policy,Valt]=ValueFnIter_FHorz_QuasiHyperbolic_nod_e_raw(n_a,n_z,n_e,N_j, a_grid, z_gridvals_J,e_gridvals_J,pi_z_J,pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    if vfoptions.lowmemory==0
        ...
        if strcmp(vfoptions.quasi_hyperbolic,'Naive')
            ...
            entireRHS=ReturnMatrix+beta0betaEV; %*repmat(EV,1,N_a,1,N_e); % Use today-to-tomorrow discount factor

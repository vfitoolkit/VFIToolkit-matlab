...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    Policyalt(5,:,:,:,N_j)=reshape(flagV_ford2_jj((1:1:N_a*N_semiz*N_e)'+(N_a*N_semiz*N_e)*(maxindexalt_lin-1)),[1,N_a,N_semiz,N_e]);
...
for reverse_j=1:N_j-1
    ...
    Policyalt(5,:,:,:,jj)=reshape(flagV_ford2_jj((1:1:N_a*N_semiz*N_e)'+(N_a*N_semiz*N_e)*(maxindexalt_lin-1)),[1,N_a,N_semiz,N_e]);
    [Vtilde_jj,maxindex]=max(Valt_ford2_jj,[],4);
    Vtilde(:,:,:,jj)=Vtilde_jj;

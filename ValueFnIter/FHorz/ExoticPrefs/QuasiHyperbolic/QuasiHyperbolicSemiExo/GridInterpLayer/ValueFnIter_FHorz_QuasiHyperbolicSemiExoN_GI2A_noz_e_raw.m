...
if ~isfield(vfoptions,'V_Jplus1')
  ...
  elseif vfoptions.lowmemory==2 % outer semiz / inner e
    ...
    Policy(6,:,:,:,N_j)=reshape(flag_ford2(idx),[1,N_a,N_semiz,N_e]);
    ...
    Policyalt(6,:,:,:,N_j)=reshape(flag_ford2alt(idxalt),[1,N_a,N_semiz,N_e]);
...
for reverse_j=1:N_j-1
    ...
    Policyalt(6,:,:,:,jj)=reshape(flag_ford2alt(idxalt),[1,N_a,N_semiz,N_e]);
    ...
    Policy(6,:,:,:,jj)=reshape(flag_ford2(idx),[1,N_a,N_semiz,N_e]);
end

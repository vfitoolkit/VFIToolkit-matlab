...
if ~isfield(vfoptions,'V_Jplus1')
  ...
  elseif vfoptions.lowmemory==2 % joint loop over bothz
    ...
    Policy(5,:,:,N_j)=reshape(flag_ford2(idx),[1,N_a,N_bothz]);
    ...
    Policyalt(5,:,:,N_j)=reshape(flag_ford2alt(idxalt),[1,N_a,N_bothz]);
...
for reverse_j=1:N_j-1
    ...
    Policyalt(5,:,:,jj)=reshape(flag_ford2alt(idxalt),[1,N_a,N_bothz]);
    ...
    Policy(5,:,:,jj)=reshape(flag_ford2(idx),[1,N_a,N_bothz]);
end

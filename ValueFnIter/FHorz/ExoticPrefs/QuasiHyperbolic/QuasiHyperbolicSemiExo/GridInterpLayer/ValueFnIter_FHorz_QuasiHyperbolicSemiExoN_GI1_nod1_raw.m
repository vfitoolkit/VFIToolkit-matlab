...
Policy=zeros(4,N_a,N_semiz*N_z,N_j,'gpuArray'); % [d2; midpoint; aprimeL2ind]
Policy(4,:,:,:)=2;
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    Policyalt(4,:,:,N_j)=reshape(flagV_ford2_jj((1:1:N_a*N_semiz*N_z)'+(N_a*N_semiz*N_z)*(maxindexalt_lin-1)),[1,N_a,N_semiz*N_z]);
...
for reverse_j=1:N_j-1
    ...
    Policyalt(4,:,:,jj)=reshape(flagV_ford2_jj((1:1:N_a*N_semiz*N_z)'+(N_a*N_semiz*N_z)*(maxindexalt_lin-1)),[1,N_a,N_semiz*N_z]);
    [Vtilde_jj,maxindex]=max(Valt_ford2_jj,[],3);
    Vtilde(:,:,jj)=Vtilde_jj;

...
if ~isfield(vfoptions,'V_Jplus1')
  ...
  elseif vfoptions.lowmemory==3 % joint bothz / inner e
    ...
    Policy(5,:,:,:,N_j)=reshape(flag_ford2(idx),[1,N_a,N_bothz,N_e]);
    ...
    Policyalt(5,:,:,:,N_j)=reshape(flag_ford2alt(idxalt),[1,N_a,N_bothz,N_e]);
...
for reverse_j=1:N_j-1
    ...
    Policyalt(5,:,:,:,jj)=reshape(flag_ford2alt(idxalt),[1,N_a,N_bothz,N_e]);
    ...
    Policy(5,:,:,:,jj)=reshape(flag_ford2(idx),[1,N_a,N_bothz,N_e]);
end

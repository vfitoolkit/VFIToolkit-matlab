...
Policy(5,:,:,:)=2;
Policyalt=zeros(5,N_a,N_semiz,N_j,'gpuArray'); % exponential discounter optimal [d1; d2; midpoint; aprimeL2ind]
Policyalt(5,:,:,:)=2;
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    Policyalt(5,:,:,N_j)=reshape(PolicyL2flagV_ford2_jj((1:1:N_a*N_semiz)'+(N_a*N_semiz)*(maxindexalt_lin-1)),[1,N_a,N_semiz]);
end
...
for reverse_j=1:N_j-1
    ...
    Policyalt(5,:,:,jj)=reshape(PolicyL2flagV_ford2_jj((1:1:N_a*N_semiz)'+(N_a*N_semiz)*(maxindexalt_lin-1)),[1,N_a,N_semiz]);
end

...
Policy=zeros(4,N_a,N_semiz*N_z,N_j,'gpuArray'); % first dim: d2, midpoint, aprimeL2ind
Policy(4,:,:,:)=2;
Policyalt=zeros(4,N_a,N_semiz*N_z,N_j,'gpuArray'); % exponential discounter optimal [d2; midpoint; aprimeL2ind]
Policyalt(4,:,:,:)=2;
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    Policy(4,:,:,N_j)=reshape(PolicyL2flag_ford2_jj((1:1:N_a*N_semiz*N_z)'+(N_a*N_semiz*N_z)*(maxindex-1)),[1,N_a,N_semiz*N_z]);
    ...
    Policyalt(4,:,:,N_j)=reshape(PolicyL2flagV_ford2_jj((1:1:N_a*N_semiz*N_z)'+(N_a*N_semiz*N_z)*(maxindexalt_lin-1)),[1,N_a,N_semiz*N_z]);
end
...
for reverse_j=1:N_j-1
    ...
    Policy(4,:,:,jj)=reshape(PolicyL2flag_ford2_jj((1:1:N_a*N_semiz*N_z)'+(N_a*N_semiz*N_z)*(maxindex-1)),[1,N_a,N_semiz*N_z]);
    ...
    Policyalt(4,:,:,jj)=reshape(PolicyL2flagV_ford2_jj((1:1:N_a*N_semiz*N_z)'+(N_a*N_semiz*N_z)*(maxindexalt_lin-1)),[1,N_a,N_semiz*N_z]);
end

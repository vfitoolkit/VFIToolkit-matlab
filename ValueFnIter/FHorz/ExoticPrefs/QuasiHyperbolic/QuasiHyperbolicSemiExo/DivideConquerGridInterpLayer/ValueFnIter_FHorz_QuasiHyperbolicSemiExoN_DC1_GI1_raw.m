...
Policy=zeros(5,N_a,N_semiz*N_z,N_j,'gpuArray'); % first dim: d1,d2,aprime midpoint, aprimeL2ind
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    Policyalt(5,:,:,N_j)=reshape(PolicyL2flagV_ford2_jj((1:1:N_a*N_semiz*N_z)'+(N_a*N_semiz*N_z)*(maxindexalt_lin-1)),[1,N_a,N_semiz*N_z]);
end
...
for reverse_j=1:N_j-1
    ...
    Policy(5,:,:,jj)=reshape(PolicyL2flag_ford2_jj((1:1:N_a*N_semiz*N_z)'+(N_a*N_semiz*N_z)*(maxindex-1)),[1,N_a,N_semiz*N_z]);
    ...
    Policyalt(5,:,:,jj)=reshape(PolicyL2flagV_ford2_jj((1:1:N_a*N_semiz*N_z)'+(N_a*N_semiz*N_z)*(maxindexalt_lin-1)),[1,N_a,N_semiz*N_z]);
end

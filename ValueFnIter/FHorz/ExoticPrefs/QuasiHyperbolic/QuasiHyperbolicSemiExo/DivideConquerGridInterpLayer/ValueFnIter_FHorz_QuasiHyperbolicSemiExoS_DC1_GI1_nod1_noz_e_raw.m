function [Vunderbar, Policy, Vhat]=ValueFnIter_FHorz_QuasiHyperbolicSemiExoS_DC1_GI1_nod1_noz_e_raw(n_d2,n_a,n_semiz, n_e,N_j, d2_gridvals, a_grid, semiz_gridvals_J, e_gridvals_J, pi_semiz_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
% Sophisticated QH + SemiExo + DC + GI raw, no d1, no z, with e. Output: (Vunderbar, Policy3, Vhat) -- matches plain QH SemiExo S raw convention.
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    if vfoptions.lowmemory==0
        for d2_c=1:N_d2
            ...
            linidx=double(reshape(maxindex,[1,N_a*N_semiz*N_e]))+n2long*(0:N_a*N_semiz*N_e-1);

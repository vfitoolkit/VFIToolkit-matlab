function [V,Policy]=ValueFnIter_FHorz_GulPesendorferExpAsset_noz_raw(n_d1, n_d2,n_a1,n_a2,N_j, d_gridvals, d2_gridvals, a1_gridvals, a2_grid, ReturnFn, TemptationFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, TemptationFnParamNames, aprimeFnParamNames, vfoptions)
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    entireRHS=ReturnMatrix+TemptationMatrix+DiscountFactorParamsVec*repelem(EV,N_d1,N_a1);

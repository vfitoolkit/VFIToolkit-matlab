function [V,Policy]=ValueFnIter_FHorz_GulPesendorferExpAsset_GI1_noz_raw(n_d1, n_d2,n_a1,n_a2,N_j, d_gridvals, d2_gridvals, a1_gridvals, a2_grid, ReturnFn, TemptationFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, TemptationFnParamNames, aprimeFnParamNames, vfoptions)
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    TemptationMatrix_Tii=CreateReturnFnMatrix_ExpAsset_Disc_noz(TemptationFn, n_d1, n_d2, n2long, n_a1,n_a2, d_gridvals, a1prime_grid(a1primeindexesT), a1_gridvals, a2_gridvals, TemptationFnParamsVec,2,0); % [N_d,N_a1prime,N_a1,N_a2]; Level=2, Refine=0
    ...
    TemptationMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_noz(TemptationFn, n_d1, n_d2, n2long, n_a1,n_a2, d_gridvals, a1prime_grid(aprimeindexes), a1_gridvals, a2_gridvals, TemptationFnParamsVec,2,0); % [N_d,N_a1prime,N_a1,N_a2]; Level=2, Refine=0
    ...
    TemptationMatrix=CreateReturnFnMatrix_ExpAsset_Disc_noz(TemptationFn, n_d1, n_d2, n_a1, n_a1,n_a2, d_gridvals, a1_gridvals, a1_gridvals, a2_gridvals, TemptationFnParamsVec,1,0); % [N_d,N_a1prime,N_a1,N_a2]; Level=1, Refine=0
    entireRHS=ReturnMatrix+TemptationMatrix+repelem(DiscountedEV,N_d1,1); % autofill 3rd dim to N_a1

function [V,Policy]=ValueFnIter_FHorz_GulPesendorferExpAsset_GI1_nod1_raw(n_d2,n_a1,n_a2,n_z,N_j, d2_gridvals, a1_gridvals, a2_grid, z_gridvals_J, pi_z_J, ReturnFn, TemptationFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, TemptationFnParamNames, aprimeFnParamNames, vfoptions)
...
if ~isfield(vfoptions,'V_Jplus1')
    if vfoptions.lowmemory==0
        ...
        TemptationMatrix=CreateReturnFnMatrix_ExpAsset_Disc(TemptationFn, 0, n_d2, n_a1, n_a1,n_a2, n_z, d2_gridvals, a1_gridvals, a1_gridvals, a2_gridvals, z_gridvals_J(:,:,N_j), TemptationFnParamsVec,1,0); % Level=1, Refine=0
        ...
        TemptationMatrix_Tii=CreateReturnFnMatrix_ExpAsset_Disc(TemptationFn, 0, n_d2, n2long, n_a1,n_a2,n_z, d2_gridvals, a1prime_grid(a1primeindexesT), a1_gridvals, a2_gridvals, z_gridvals_J(:,:,N_j), TemptationFnParamsVec,2,0); % [N_d,N_a1prime,N_a1,N_a2]; Level=2, Refine=0
        ...
        TemptationMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc(TemptationFn, 0, n_d2, n2long, n_a1,n_a2,n_z, d2_gridvals, a1prime_grid(aprimeindexes), a1_gridvals, a2_gridvals, z_gridvals_J(:,:,N_j), TemptationFnParamsVec,2,0); % [N_d,N_a1prime,N_a1,N_a2]; Level=2, Refine=0
    ...
    elseif vfoptions.lowmemory==1
        for z_c=1:N_z
            ...
            TemptationMatrix_z=CreateReturnFnMatrix_ExpAsset_Disc(TemptationFn, 0, n_d2, n_a1, n_a1,n_a2, special_n_z, d2_gridvals, a1_gridvals, a1_gridvals, a2_gridvals, z_val, TemptationFnParamsVec,1,0); % Level=1, Refine=0
            % Calc the max and it's index
            ...
            midpointT=max(min(maxindexT,n_a1(1)-1),2);
            a1primeindexesT=(midpointT+(midpointT-1)*n2short)+(-n2short-1:1:1+n2short);
            TemptationMatrix_Tii=CreateReturnFnMatrix_ExpAsset_Disc(TemptationFn, 0, n_d2, n2long, n_a1,n_a2,special_n_z, d2_gridvals, a1prime_grid(a1primeindexesT), a1_gridvals, a2_gridvals, z_val, TemptationFnParamsVec,2,0); % [N_d,N_a1prime,N_a1,N_a2]; Level=2, Refine=0
            MostTempting=max(TemptationMatrix_Tii,[],1);
            MostTempting(MostTempting==-Inf)=0; % a state where EVERY choice is infeasible leaves this -Inf: V there must be -Inf (as in the standard solver), not -Inf-(-Inf)=NaN
            ...
            TemptationMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc(TemptationFn, 0, n_d2, n2long, n_a1,n_a2,special_n_z, d2_gridvals, a1prime_grid(aprimeindexes), a1_gridvals, a2_gridvals, z_val, TemptationFnParamsVec,2,0); % [N_d,N_a1prime,N_a1,N_a2]; Level=2, Refine=0
            Ftemp_ii=ReturnMatrix_ii+TemptationMatrix_ii;
            [Vtempii,maxindexL2]=max(Ftemp_ii,[],1);
...
for reverse_j=1:N_j-1
    ...
    if vfoptions.lowmemory==0
        ...
        TemptationMatrix=CreateReturnFnMatrix_ExpAsset_Disc(TemptationFn, 0, n_d2, n_a1, n_a1,n_a2, n_z, d2_gridvals, a1_gridvals, a1_gridvals, a2_gridvals, z_gridvals_J(:,:,jj), TemptationFnParamsVec,1,0); % Level=1, Refine=0
        entireRHS=ReturnMatrix+TemptationMatrix+DiscountedEV; % autofill 3rd dim to N_a1
        ...
        midpointT=max(min(maxindexT,n_a1(1)-1),2);
        a1primeindexesT=(midpointT+(midpointT-1)*n2short)+(-n2short-1:1:1+n2short);
        TemptationMatrix_Tii=CreateReturnFnMatrix_ExpAsset_Disc(TemptationFn, 0, n_d2, n2long, n_a1,n_a2,n_z, d2_gridvals, a1prime_grid(a1primeindexesT), a1_gridvals, a2_gridvals, z_gridvals_J(:,:,jj), TemptationFnParamsVec,2,0); % [N_d,N_a1prime,N_a1,N_a2]; Level=2, Refine=0
        MostTempting=max(TemptationMatrix_Tii,[],1);
        MostTempting(MostTempting==-Inf)=0; % a state where EVERY choice is infeasible leaves this -Inf: V there must be -Inf (as in the standard solver), not -Inf-(-Inf)=NaN

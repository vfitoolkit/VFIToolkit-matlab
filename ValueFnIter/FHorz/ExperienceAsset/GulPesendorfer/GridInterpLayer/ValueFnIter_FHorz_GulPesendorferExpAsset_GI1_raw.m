function [V,Policy]=ValueFnIter_FHorz_GulPesendorferExpAsset_GI1_raw(n_d1,n_d2,n_a1,n_a2,n_z,N_j, d_gridvals, d2_gridvals, a1_gridvals, a2_grid, z_gridvals_J, pi_z_J, ReturnFn, TemptationFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, TemptationFnParamNames, aprimeFnParamNames, vfoptions)
...
if ~isfield(vfoptions,'V_Jplus1')
    if vfoptions.lowmemory==0
        ...
        TemptationMatrix=CreateReturnFnMatrix_ExpAsset_Disc(TemptationFn, n_d1,n_d2,n_a1,n_a1,n_a2,n_z, d_gridvals, a1_gridvals, a1_gridvals, a2_gridvals, z_gridvals_J(:,:,N_j), TemptationFnParamsVec,1,0); % Level=1, Refine=0
        ...
        TemptationMatrix_Tii=CreateReturnFnMatrix_ExpAsset_Disc(TemptationFn, n_d1,n_d2,n2long,n_a1,n_a2,n_z, d_gridvals, a1prime_grid(a1primeindexesT), a1_gridvals, a2_gridvals, z_gridvals_J(:,:,N_j), TemptationFnParamsVec,2,0); % [N_d,N_a1prime,N_a1,N_a2,N_z]; Level=2, Refine=0
        ...
        TemptationMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc(TemptationFn, n_d1,n_d2,n2long,n_a1,n_a2,n_z, d_gridvals, a1prime_grid(aprimeindexes), a1_gridvals, a2_gridvals, z_gridvals_J(:,:,N_j), TemptationFnParamsVec,2,0); % [N_d,N_a1prime,N_a1,N_a2,N_z]; Level=2, Refine=0
    ...
    elseif vfoptions.lowmemory==1
        for z_c=1:N_z
            ...
            TemptationMatrix_z=CreateReturnFnMatrix_ExpAsset_Disc(TemptationFn, n_d1,n_d2,n_a1,n_a1,n_a2,special_n_z, d_gridvals, a1_gridvals, a1_gridvals, a2_gridvals, z_val, TemptationFnParamsVec,1,0); % Level=1, Refine=0
            % Calc the max and it's index
            ...
            midpointT=max(min(maxindexT,n_a1(1)-1),2);
            a1primeindexesT=(midpointT+(midpointT-1)*n2short)+(-n2short-1:1:1+n2short);
            TemptationMatrix_Tii=CreateReturnFnMatrix_ExpAsset_Disc(TemptationFn, n_d1,n_d2,n2long,n_a1,n_a2,special_n_z, d_gridvals, a1prime_grid(a1primeindexesT), a1_gridvals, a2_gridvals, z_val, TemptationFnParamsVec,2,0); % [N_d,N_a1prime,N_a1,N_a2]; Level=2, Refine=0
            MostTempting=max(TemptationMatrix_Tii,[],1);
            MostTempting(MostTempting==-Inf)=0; % a state where EVERY choice is infeasible leaves this -Inf: V there must be -Inf (as in the standard solver), not -Inf-(-Inf)=NaN
            ...
            TemptationMatrix_ii_z=CreateReturnFnMatrix_ExpAsset_Disc(TemptationFn, n_d1,n_d2,n2long,n_a1,n_a2,special_n_z, d_gridvals, a1prime_grid(aprimeindexes), a1_gridvals, a2_gridvals, z_val, TemptationFnParamsVec,2,0); % [N_d,N_a1prime,N_a1,N_a2]; Level=2, Refine=0
            Ftemp_ii_z=ReturnMatrix_ii_z+TemptationMatrix_ii_z;
            [Vtempii,maxindexL2]=max(Ftemp_ii_z,[],1);
    ...
    if vfoptions.lowmemory==0
        ...
        TemptationMatrix=CreateReturnFnMatrix_ExpAsset_Disc(TemptationFn, n_d1,n_d2,n_a1,n_a1,n_a2,n_z, d_gridvals, a1_gridvals, a1_gridvals, a2_gridvals, z_gridvals_J(:,:,N_j), TemptationFnParamsVec,1,0); % [N_d,N_a1prime,N_a1,N_a2,N_z]; Level=1, Refine=0
        ...
        TemptationMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc(TemptationFn, n_d1,n_d2,n2long,n_a1,n_a2,n_z, d_gridvals, a1prime_grid(a1primeindexesfine), a1_gridvals, a2_gridvals, z_gridvals_J(:,:,N_j), TemptationFnParamsVec,2,0); % [N_d,N_a1prime,N_a1,N_a2,N_z]; Level=2, Refine=0
        Ftemp_ii=ReturnMatrix_ii+TemptationMatrix_ii;
    ...
    elseif vfoptions.lowmemory==1
        ...
        for z_c=1:N_z
            ...
            TemptationMatrix_z=CreateReturnFnMatrix_ExpAsset_Disc(TemptationFn, n_d1,n_d2,n_a1,n_a1,n_a2,special_n_z, d_gridvals, a1_gridvals, a1_gridvals, a2_gridvals, z_val, TemptationFnParamsVec,1,0); % [N_d,N_a1prime,N_a1,N_a2]; Level=1, Refine=0
            entireRHS_z=ReturnMatrix_z+TemptationMatrix_z+DiscountedEV_z; % autofill 3rd dim to N_a1
            ...
            midpointT=max(min(maxindexT,n_a1(1)-1),2);
            a1primeindexesT=(midpointT+(midpointT-1)*n2short)+(-n2short-1:1:1+n2short);
            TemptationMatrix_Tii=CreateReturnFnMatrix_ExpAsset_Disc(TemptationFn, n_d1,n_d2,n2long,n_a1,n_a2,special_n_z, d_gridvals, a1prime_grid(a1primeindexesT), a1_gridvals, a2_gridvals, z_val, TemptationFnParamsVec,2,0); % [N_d,N_a1prime,N_a1,N_a2,N_z]; Level=2, Refine=0
            MostTempting=max(TemptationMatrix_Tii,[],1);
            MostTempting(MostTempting==-Inf)=0; % a state where EVERY choice is infeasible leaves this -Inf: V there must be -Inf (as in the standard solver), not -Inf-(-Inf)=NaN
            ...
            TemptationMatrix_ii_z=CreateReturnFnMatrix_ExpAsset_Disc(TemptationFn, n_d1,n_d2,n2long,n_a1,n_a2,special_n_z, d_gridvals, a1prime_grid(a1primeindexesfine), a1_gridvals, a2_gridvals, z_val, TemptationFnParamsVec,2,0); % [N_d,N_a1prime,N_a1,N_a2,N_z]; Level=2, Refine=0
            Ftemp_ii_z=ReturnMatrix_ii_z+TemptationMatrix_ii_z;
            da1primea2=(1:1:N_d)'+N_d*(a1primeindexesfine-1)+N_d*N_a1prime*a2ind;
            entireRHS_ii=Ftemp_ii_z+reshape(DiscountedEVinterp_z(da1primea2(:)),[N_d*n2long,N_a1*N_a2]);
            [Vtempii,maxindexL2]=max(entireRHS_ii,[],1);
            V(:,z_c,N_j)=shiftdim(Vtempii-MostTempting,1);
            d_ind=rem(maxindexL2-1,N_d)+1;
            allind=d_ind+N_d*aind; % midpoint is n_d-by-1-by-n_a1-by-n_a2
...
for reverse_j=1:N_j-1
    ...
    if vfoptions.lowmemory==0
        ...
        TemptationMatrix=CreateReturnFnMatrix_ExpAsset_Disc(TemptationFn, n_d1,n_d2,n_a1,n_a1,n_a2,n_z, d_gridvals, a1_gridvals, a1_gridvals, a2_gridvals, z_gridvals_J(:,:,jj), TemptationFnParamsVec,1,0); % [N_d,N_a1prime,N_a1,N_a2,N_z]; Level=1, Refine=0
        entireRHS=ReturnMatrix+TemptationMatrix+DiscountedEV; % autofill 3rd dim to N_a1
        ...
        midpointT=max(min(maxindexT,n_a1(1)-1),2);
        a1primeindexesT=(midpointT+(midpointT-1)*n2short)+(-n2short-1:1:1+n2short);
        TemptationMatrix_Tii=CreateReturnFnMatrix_ExpAsset_Disc(TemptationFn, n_d1,n_d2,n2long,n_a1,n_a2,n_z, d_gridvals, a1prime_grid(a1primeindexesT), a1_gridvals, a2_gridvals, z_gridvals_J(:,:,jj), TemptationFnParamsVec,2,0); % [N_d,N_a1prime,N_a1,N_a2,N_z]; Level=2, Refine=0
        MostTempting=max(TemptationMatrix_Tii,[],1);
        MostTempting(MostTempting==-Inf)=0; % a state where EVERY choice is infeasible leaves this -Inf: V there must be -Inf (as in the standard solver), not -Inf-(-Inf)=NaN
        ...
        TemptationMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc(TemptationFn, n_d1,n_d2,n2long,n_a1,n_a2,n_z, d_gridvals, a1prime_grid(a1primeindexesfine), a1_gridvals, a2_gridvals, z_gridvals_J(:,:,jj), TemptationFnParamsVec,2,0); % [N_d,N_a1prime,N_a1,N_a2,N_z]; Level=2, Refine=0
        Ftemp_ii=ReturnMatrix_ii+TemptationMatrix_ii;
        da1primea2z=(1:1:N_d)'+N_d*(a1primeindexesfine-1)+N_d*N_a1prime*a2ind+N_d*N_a1prime*N_a2*zind;
        entireRHS_ii=Ftemp_ii+reshape(DiscountedEVinterp(da1primea2z(:)),[N_d*n2long,N_a1*N_a2,N_z]);
        [Vtempii,maxindexL2]=max(entireRHS_ii,[],1);

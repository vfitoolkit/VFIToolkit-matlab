function [V,Policy]=ValueFnIter_FHorz_GulPesendorferExpAsset_DC1_GI1_noz_raw(n_d1, n_d2,n_a1,n_a2,N_j, d_gridvals, d2_gridvals, a1_gridvals, a2_grid, ReturnFn, TemptationFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, TemptationFnParamNames, aprimeFnParamNames, vfoptions)
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    for ii=1:(vfoptions.level1n-1)
        ...
        TemptationMatrix_full=CreateReturnFnMatrix_ExpAsset_Disc_noz(TemptationFn, n_d1,n_d2,n_a1,length(curraindex),n_a2, d_gridvals, a1_gridvals, a1_gridvals(curraindex), a2_gridvals, TemptationFnParamsVec,1,0);
        ...
        if maxgap(ii)>0
            ...
            TemptationMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_noz(TemptationFn, n_d1,n_d2,maxgap(ii)+1,level1iidiff(ii),n_a2, d_gridvals, a1_gridvals(a1primeindexes), a1_gridvals(level1ii(ii)+1:level1ii(ii+1)-1), a2_gridvals, TemptationFnParamsVec,3,0); % Level 3 as DC1+GI; Level=3, Refine=0
    ...
    TemptationMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_noz(TemptationFn, n_d1, n_d2, n2long, n_a1,n_a2, d_gridvals, a1prime_grid(a1primeindexes), a1_gridvals, a2_gridvals, TemptationFnParamsVec,2,0); % [N_d,N_a1prime,N_a1,N_a2]; Level=2, Refine=0
    ...
    TemptationMatrix_Tii=CreateReturnFnMatrix_ExpAsset_Disc_noz(TemptationFn, n_d1, n_d2, n2long, n_a1,n_a2, d_gridvals, a1prime_grid(a1primeindexesT), a1_gridvals, a2_gridvals, TemptationFnParamsVec,2,0);
    ...
    entireRHS_ii=ReturnMatrix_ii+TemptationMatrix_ii+repelem(DiscountedEV,N_d1,1,1,1); % autofill 3rd dim to N_a1;
    ...
    TemptationMatrix_ii=CreateReturnFnMatrix_ExpAsset_Disc_noz(TemptationFn, n_d1, n_d2, n2long, n_a1,n_a2, d_gridvals, a1prime_grid(a1primeindexesfine), a1_gridvals, a2_gridvals, TemptationFnParamsVec,2,0); % [N_d,N_a1prime,N_a1,N_a2]; Level=2, Refine=0
    Ftemp_ii=ReturnMatrix_ii+TemptationMatrix_ii;

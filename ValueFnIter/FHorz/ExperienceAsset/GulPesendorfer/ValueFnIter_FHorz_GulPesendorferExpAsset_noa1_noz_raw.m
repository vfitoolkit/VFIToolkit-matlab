function [V,Policy]=ValueFnIter_FHorz_GulPesendorferExpAsset_noa1_noz_raw(n_d1,n_d2,n_a2,N_j, d_gridvals, d2_gridvals, a2_grid, ReturnFn, TemptationFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, TemptationFnParamNames, aprimeFnParamNames, vfoptions)
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    TemptationMatrix=CreateReturnFnMatrix_Case2_Disc_noz(TemptationFn,[n_d1,n_d2], n_a2, d_gridvals, a2_gridvals, TemptationFnParamsVec); % with only the experience asset, can just use Case2 command
    ...
    entireRHS=ReturnMatrix+TemptationMatrix+DiscountFactorParamsVec*repelem(EV,N_d1,1);

function [V,Policy]=ValueFnIter_Case1_FHorz_ExpAsset_nod1_noa1_e_raw(n_d2,n_a2,n_z,n_e,N_j, d2_grid, a2_grid,z_gridvals_J,e_gridvals_J,pi_z_J,pi_e_J, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    entireRHS=ReturnMatrix+DiscountFactorParamsVec*entireEV; % should autofill the e dimension

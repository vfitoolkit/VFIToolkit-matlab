...
Policy=zeros(6,N_a,N_semiz*N_z,N_j,'gpuArray');
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    Policy(6,:,:,N_j)=reshape(flag_ford3_jj((1:1:N_a*N_bothz)'+(N_a*N_bothz)*(maxindex-1)),[1,N_a,N_bothz]);
else
...
for reverse_j=1:N_j-1
    ...
    Policy(6,:,:,jj)=reshape(flag_ford3_jj((1:1:N_a*N_bothz)'+(N_a*N_bothz)*(maxindex-1)),[1,N_a,N_bothz]);
end

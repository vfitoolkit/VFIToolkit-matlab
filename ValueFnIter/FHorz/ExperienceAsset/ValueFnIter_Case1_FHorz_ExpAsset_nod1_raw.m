function [V,Policy]=ValueFnIter_Case1_FHorz_ExpAsset_nod1_raw(n_d2,n_a1,n_a2,n_z,N_j, d2_grid, a1_grid, a2_grid, z_grid, pi_z, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
...
if ~isfield(vfoptions,'V_Jplus1')
    if vfoptions.lowmemory==0
        ...
        ReturnMatrix=CreateReturnFnMatrix_Case1_ExpAsset_Disc_Par2(ReturnFn, n_d2, n_a1,n_a2, n_z, d2_grid, a1_grid, a2_grid, z_grid, ReturnFnParamsVec);
...
%             entireEV=repelem(EV,n_d2,1,1); % I tried this instead but appears repelem() is slower than kron(). However kron() requires 2-D so here I just use repelem() anyway.
        ...
        elseif vfoptions.paroverz==0
            ...
            for z_c=1:N_z
                ...
                entireRHS_z=ReturnMatrix_z+DiscountFactorParamsVec*kron(entireEV_z,ones(1,N_a1,1));

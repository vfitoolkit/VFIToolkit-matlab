...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    if vfoptions.lowmemory==0
        for d3_c=1:N_d3
            ...
            ReturnMatrix_d3=CreateReturnFnMatrix_Case1_ExpAsset_Disc_Par2e(ReturnFn, [n_d1,n_d2,1], n_a1,n_a2, n_bothz,n_e, [d1_grid;d2_grid;d3_val], a1_grid, a2_grid, bothz_gridvals_J(:,:,N_j), e_gridvals_J(:,:,N_j), ReturnFnParamsVec);
            % (d,aprime,a,z)
    ...
    elseif vfoptions.lowmemory==1
        for d3_c=1:N_d3
            ...
            for e_c=1:N_e
                ...
                ReturnMatrix_d3e=CreateReturnFnMatrix_Case1_ExpAsset_Disc_Par2e(ReturnFn, [n_d1,n_d2,1], n_a1,n_a2, n_bothz,special_n_e, [d1_grid;d2_grid;d3_val], a1_grid, a2_grid, bothz_gridvals_J(:,:,N_j), e_val, ReturnFnParamsVec);
                % (d,aprime,a,z)
    ...
    elseif vfoptions.lowmemory==2
        for d3_c=1:N_d3
            ...
            for e_c=1:N_e
                ...
                for z_c=1:N_bothz
                    z_val=bothz_gridvals_J(z_c,:,N_j);
                    ReturnMatrix_d3ze=CreateReturnFnMatrix_Case1_ExpAsset_Disc_Par2e(ReturnFn, [n_d1,n_d2,1], n_a1,n_a2, special_n_bothz,special_n_e, [d1_grid;d2_grid;d3_val], a1_grid, a2_grid, z_val,e_val, ReturnFnParamsVec);
...
for reverse_j=1:N_j-1
    ...
    if vfoptions.lowmemory==0
        for d3_c=1:N_d3
            ...
            ReturnMatrix_d3=CreateReturnFnMatrix_Case1_ExpAsset_Disc_Par2e(ReturnFn, [n_d1,n_d2,1], n_a1,n_a2, n_bothz,n_e, [d1_grid;d2_grid;d3_val], a1_grid, a2_grid, bothz_gridvals_J(:,:,jj), e_gridvals_J(:,:,jj), ReturnFnParamsVec);
            % (d,aprime,a,z)
    ...
    elseif vfoptions.lowmemory==1
        ...
        for d3_c=1:N_d3
            for e_c=1:N_e
                ...
                ReturnMatrix_d3e=CreateReturnFnMatrix_Case1_ExpAsset_Disc_Par2e(ReturnFn, [n_d1,n_d2,1], n_a1,n_a2, n_bothz,special_n_e, [d1_grid;d2_grid;d3_val], a1_grid, a2_grid, bothz_gridvals_J(:,:,jj), e_val, ReturnFnParamsVec);
                % (d,aprime,a,z)

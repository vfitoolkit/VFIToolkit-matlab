function [V,Policy3]=ValueFnIter_Case1_FHorz_ExpAssetSemiExo_raw(n_d1,n_d2,n_d3,n_a1,n_a2,n_z,n_semiz,N_j, d1_grid, d2_grid, d3_grid, a1_grid, a2_grid, z_gridvals_J, semiz_gridvals_J, pi_z_J, pi_semiz_J, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    if vfoptions.lowmemory==0
        for d3_c=1:N_d3
            ...
            ReturnMatrix_d3=CreateReturnFnMatrix_Case1_ExpAsset_Disc_Par2(ReturnFn, [n_d1,n_d2,1], n_a1,n_a2, n_bothz, [d1_grid;d2_grid;d3_val], a1_grid, a2_grid, bothz_gridvals_J(:,:,N_j), ReturnFnParamsVec);
            % (d,aprime,a,z)
            ...
            if vfoptions.paroverz==1
                ...
                EV2=EV((aprimeplus1Index)+N_a*((1:1:N_bothz)-1)); % (d2,a1prime,a2,z), the upper aprime
    ...
    elseif vfoptions.lowmemory==1
        for d3_c=1:N_d3
            ...
            for z_c=1:N_bothz
                z_val=bothz_gridvals_J(z_c,:,N_j);
                ReturnMatrix_d3z=CreateReturnFnMatrix_Case1_ExpAsset_Disc_Par2(ReturnFn, [n_d1,n_d2,1], n_a1,n_a2, special_n_bothz, [d1_grid;d2_grid;d3_val], a1_grid, a2_grid, z_val, ReturnFnParamsVec);
...
for reverse_j=1:N_j-1
    ...
    if vfoptions.lowmemory==0
        for d3_c=1:N_d3
            ...
            ReturnMatrix_d3=CreateReturnFnMatrix_Case1_ExpAsset_Disc_Par2(ReturnFn, [n_d1,n_d2,1], n_a1,n_a2, n_bothz, [d1_grid;d2_grid;d3_val], a1_grid, a2_grid, bothz_gridvals_J(:,:,jj), ReturnFnParamsVec);
            % (d,aprime,a,z)

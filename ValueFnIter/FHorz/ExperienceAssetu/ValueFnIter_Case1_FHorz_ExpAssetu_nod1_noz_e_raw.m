...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    V_Jplus1=sum(pi_e_J(:,N_j)'.*reshape(vfoptions.V_Jplus1,[N_a,N_e]),2);    % Expectations over e
...
for reverse_j=1:N_j-1
    ...
    entireRHS=ReturnMatrix+DiscountFactorParamsVec*repelem(EV,1,N_a1); % should autofill e dimension

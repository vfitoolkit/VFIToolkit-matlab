...
% Policy stores (d1, d2, d3, joint(a1prime,a2prime), a1primeL2ind) with the L2 flag as a 6th row; the joint row is a1prime+N_a1*(a2prime-1), a1prime being the lower grid point.
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    Policy(6,:,:,:,N_j)=reshape(flag_ford3_jj((1:1:N_a*N_semiz*N_e)'+(N_a*N_semiz*N_e)*(maxindex-1)),[1,N_a,N_semiz,N_e]);
...
for reverse_j=1:N_j-1
    ...
    Policy(6,:,:,:,jj)=reshape(flag_ford3_jj((1:1:N_a*N_semiz*N_e)'+(N_a*N_semiz*N_e)*(maxindex-1)),[1,N_a,N_semiz,N_e]);
end

...
Policy4=zeros(6,N_a,N_semiz,N_j,'gpuArray'); % 1=d1, 2=d2, 3=d3, 4=joint(a1prime midpoint,a2prime), 5=a1prime L2
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    Policy4(6,:,:,N_j)=reshape(L2flag_ford3_jj(idx),[1,N_a,N_semiz]);
end
...
for reverse_j=1:N_j-1
    ...
    Policy4(6,:,:,jj)=reshape(L2flag_ford3_jj(idx),[1,N_a,N_semiz]);
end

...
Policy3=zeros(5,N_a,N_semiz*N_z,N_j,'gpuArray'); % 1=d2, 2=d3, 3=joint(a1prime,a2prime), 4=a1prime L2
...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    Policy3(5,:,:,N_j)=reshape(flag_ford3_jj((1:N_a*N_bothz)'+(N_a*N_bothz)*(maxindex-1)),[1,N_a,N_bothz]);
...
for reverse_j=1:N_j-1
    ...
    Policy3(5,:,:,jj)=reshape(flag_ford3_jj((1:N_a*N_bothz)'+(N_a*N_bothz)*(maxindex-1)),[1,N_a,N_bothz]);

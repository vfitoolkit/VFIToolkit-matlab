function [V,Policy]=ValueFnIter_Case2_3_FHorz_e_Par2_raw(n_d,n_a,n_z,n_e,N_j, d_grid, a_grid, z_grid, e_grid, pi_z, pi_e,Phi_aprime, Case2_Type, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, PhiaprimeParamNames, vfoptions)
...
Policy=zeros(N_a,N_z,N_e,N_j,'gpuArray'); %indexes the optimal choice for d given rest of dimensions a,z,e
...
for reverse_j=1:N_j-1
    ...
    elseif vfoptions.lowmemory==1
        ...
        for e_c=1:N_e
            ...
            entireRHS=ReturnMatrix_e+DiscountFactorParamsVec*repmat(EV,1,N_a,1);
    ...
    elseif vfoptions.lowmemory==2
        ...
        for e_c=1:N_e
            ...
            for z_c=1:N_z
                ...
                entireRHS=ReturnMatrix_ze+DiscountFactorParamsVec*EV_z.*ones(1,N_a); %d by a (by z)

                %calculate in order, the maximizing aprime indexes
                [V(:,z_c,e_c,jj),Policy(:,z_c,e_c,jj)]=max(entireRHS,[],1);

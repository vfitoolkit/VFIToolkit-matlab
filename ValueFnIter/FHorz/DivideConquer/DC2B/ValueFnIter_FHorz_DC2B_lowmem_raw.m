function [V,Policy2]=ValueFnIter_FHorz_DC2B_lowmem_raw(n_d,n_a,n_z,N_j, d_gridvals, a_grid, z_gridvals_J, pi_z_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
...
% lowmem, so no need for zind, zBind

...
if ~isfield(vfoptions,'V_Jplus1')
    ...
    midpoints_jj(level1ii)=maxindex;
    ...
    for ii=1:(vfoptions.level1n-1)
        ...
        [~,maxindex]=max(ReturnMatrix_ii,[],1);
        midpoints_jj(curraindex)=shiftdim(maxindex,1)+Policy(level1ii(ii),N_j)-1;
    end
...
for reverse_j=1:N_j-1
    ...
    for ii=1:(vfoptions.level1n-1)
        ...
        [~,maxindex]=max(entireRHS_ii,[],1);
        midpoints_jj(curraindex)=shiftdim(maxindex,1)+Policy(level1ii(ii),jj)-1;
    end

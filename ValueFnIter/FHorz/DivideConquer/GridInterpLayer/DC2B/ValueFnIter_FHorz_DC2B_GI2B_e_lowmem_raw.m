function [V, Policy]=ValueFnIter_FHorz_DC2B_GI2B_e_lowmem_raw(n_d,n_a,n_z,n_e, N_j, d_gridvals, a_grid, z_gridvals_J, e_gridvals_J, pi_z_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
    ...
    for e_c=1:N_e
        ...
        for ii=1:(vfoptions.level1n-1)
            ...
            if maxgap(ii)>0
                ...
                % n_d-by-maxgap(ii)+1-by-n_a2-by-1-by-n_a2-by-n_z

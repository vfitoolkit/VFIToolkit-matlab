function [VKron, Policy, ExitPolicy]=ValueFnIter_Case1_EndogExit_SemiEndog_NoD_Par2_raw(VKron, n_a, n_z, pi_z_semiendog, beta, ReturnMatrix,ReturnToExitMatrix, Howards,Howards2,Tolerance, keeppolicyonexit) % Verbose, a_grid, z_grid, 

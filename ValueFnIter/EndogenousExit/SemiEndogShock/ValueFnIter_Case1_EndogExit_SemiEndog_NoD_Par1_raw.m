function [VKron, Policy, ExitPolicy]=ValueFnIter_Case1_EndogExit_SemiEndog_NoD_Par1_raw(VKron, N_a, N_z, pi_z_semiendog, beta, ReturnMatrix,ReturnToExitMatrix, Howards,Howards2, Tolerance, keeppolicyonexit) %Verbose

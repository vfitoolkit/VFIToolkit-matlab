function [VKron, Policy, ExitPolicy]=ValueFnIter_Case1_EndogExit_NoD_raw(VKron, N_a, N_z, pi_z, beta, ReturnMatrix,ReturnToExitMatrix, Howards,Howards2,Tolerance, keeppolicyonexit) 

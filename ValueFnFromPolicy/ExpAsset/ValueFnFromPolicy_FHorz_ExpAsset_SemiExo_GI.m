function V=ValueFnFromPolicy_FHorz_ExpAsset_SemiExo_GI(Policy,n_d,n_a,n_z,N_j,d_grid,a_grid,z_grid, pi_z, ReturnFn, Parameters, DiscountFactorParamNames, vfoptions)
...
if isscalar(n_a)
    error('ValueFnFromPolicy_FHorz_ExpAsset_SemiExo_GI: case with no a1 (experience asset as only asset) not yet implemented')
end
n_a1=n_a(1:end-1);
N_a1=prod(n_a1);
n_a2=n_a(end);

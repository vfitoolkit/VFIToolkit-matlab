function [V, Policy]=ValueFnFromPolicy_Case1_FHorz_PType(Policy, n_d,n_a,n_z, N_j,Names_i,d_grid, a_grid, z_grid, pi_z, ReturnFn, Parameters, DiscountFactorParamNames, vfoptions)
...
for ii=1:N_i
    ...
    if isfinite(N_j_temp)
        V_ii=ValueFnFromPolicy_Case1_FHorz(Policy_ii,n_d_temp,n_a_temp,n_z_temp,N_j_temp,d_grid_temp, a_grid_temp, z_grid_temp, pi_z_temp, ReturnFn_temp, Parameters_temp, DiscountFactorParamNames_temp, vfoptions_temp);
    else % PType actually allows for infinite horizon as well
        V_ii=ValueFnFromPolicy_Case1(Policy_ii,n_d_temp,n_a_temp,n_z_temp,d_grid_temp, a_grid_temp, z_grid_temp, pi_z_temp, ReturnFn_temp, Parameters_temp, DiscountFactorParamNames_temp, vfoptions);
    end

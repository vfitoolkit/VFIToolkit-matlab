function StationaryDist=StationaryDist_FHorz_Case1_Iteration(jequaloneDist,Policy,n_d,n_a,n_z,pi_z,simoptions)
...
StationaryDistKron=StationaryDist_FHorz_Case1_Iteration_raw(jequaloneDistKron,PolicyKron,N_d,N_a,N_z,pi_z,simoptions);

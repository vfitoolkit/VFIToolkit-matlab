...
if simoptions.iterate==0
    StationaryDist=StationaryDist_FHorz_Case1_Simulation_e_raw(jequaloneDist,AgeWeightParamNames,Policy,N_d,N_a,N_z,N_e,N_j,pi_z_J,pi_e_J,Parameters,simoptions);

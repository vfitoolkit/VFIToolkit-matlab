function StationaryDistKron=StationaryDist_FHorz_Iteration_raw(jequaloneDistKron,AgeWeightParamNames,PolicyIndexesKron,N_d,N_a,N_z,N_j,pi_z_J,Parameters,simoptions)

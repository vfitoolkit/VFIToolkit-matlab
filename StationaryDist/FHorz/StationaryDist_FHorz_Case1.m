function StationaryDist=StationaryDist_FHorz_Case1(jequaloneDist,Policy,n_d,n_a,n_z,N_j,pi_z,simoptions)
...
if simoptions.iterate==0
    StationaryDistKron=StationaryDist_FHorz_Case1_Simulation_raw(jequaloneDistKron,PolicyKron,N_d,N_a,N_z,N_j,pi_z, simoptions);
elseif simoptions.iterate==1
    StationaryDistKron=StationaryDist_FHorz_Case1_Iteration_raw(jequaloneDistKron,PolicyKron,N_d,N_a,N_z,N_j,pi_z,simoptions);
end

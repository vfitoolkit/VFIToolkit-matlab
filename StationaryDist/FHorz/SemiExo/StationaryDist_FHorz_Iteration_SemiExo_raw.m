function StationaryDistKron=StationaryDist_FHorz_Iteration_SemiExo_raw(jequaloneDistKron,AgeWeightParamNames,Policy_dsemiexo,Policy_aprime,N_a,N_semiz,N_z,N_j,pi_semiz_J,pi_z_J,Parameters)

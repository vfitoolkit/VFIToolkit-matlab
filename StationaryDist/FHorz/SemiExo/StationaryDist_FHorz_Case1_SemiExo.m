...
if simoptions.iterate==0
    StationaryDist=StationaryDist_FHorz_Case1_SemiExo_Simulation_raw(jequaloneDist,AgeWeightParamNames,Policy,n_d1,n_d2,N_a,N_z,N_semiz,N_j,pi_z_J,pi_semiz_J,Parameters,simoptions);

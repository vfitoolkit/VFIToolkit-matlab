function StationaryDist=StationaryDist_FHorz_SemiExo_GI(jequaloneDist,AgeWeightParamNames,Policy,n_d,n_a,n_semiz,n_z,N_j,pi_semiz_J,pi_z_J,Parameters,simoptions)
...
%%
jequaloneDist=gather(reshape(jequaloneDist,[N_a*N_semiz*N_z,1]));

Policy=reshape(Policy,[size(Policy,1),N_a,N_bothz,1,N_j]);

function StationaryDistKron=StationaryDist_FHorz_Case1_SemiExo_Iteration_raw(jequaloneDistKron,AgeWeightParamNames,PolicyIndexesKron,N_d1,N_a,N_z,N_semiz,N_j,pi_z_J,pi_semiz_J,Parameters,simoptions)
...
if N_d1==0
    ...
    optd2prime=reshape(ceil(PolicyIndexesKron(1,:,:,:)/N_d1),[N_a*N_bothz,N_j]);   
end

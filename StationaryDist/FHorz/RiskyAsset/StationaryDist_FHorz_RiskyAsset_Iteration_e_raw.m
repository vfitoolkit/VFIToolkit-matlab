function StationaryDistKron=StationaryDist_FHorz_RiskyAsset_Iteration_e_raw(jequaloneDistKron,AgeWeightParamNames,PolicyKron,n_d,n_a,n_z,n_e,n_u,N_j,d_grid,a_grid,u_grid,pi_z_J,pi_e_J,pi_u,aprimeFn,Parameters,aprimeFnParamNames,simoptions)
% Case3: aprime(d,u)

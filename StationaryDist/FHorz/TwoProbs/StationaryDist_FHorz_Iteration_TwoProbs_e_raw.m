function StationaryDist=StationaryDist_FHorz_Iteration_TwoProbs_e_raw(jequaloneDistKron,AgeWeightParamNames,Policy_aprime,PolicyProbs,N_a,N_z,N_e,N_j,pi_z_J,pi_e_J,Parameters)

function StationaryDist=StationaryDist_FHorz_GI_noz(jequaloneDist,AgeWeightParamNames,Policy,n_d,n_a,N_j,Parameters,simoptions)
...
jequaloneDist=gather(reshape(jequaloneDist,[N_a,1]));
...
Policy_aprime=zeros(N_a,2,N_j,'gpuArray'); % the lower grid point
...
%%
StationaryDist=StationaryDist_FHorz_Iteration_TwoProbs_noz_raw(jequaloneDist,AgeWeightParamNames,Policy_aprime,PolicyProbs,N_a,N_j,Parameters);

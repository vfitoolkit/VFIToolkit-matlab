...
for ii=1:N_i
    ...
    if isfinite(N_j_temp)
        ...
        AgentDistPath_ii=AgentDistOnTransPath_InfHorz(AgentDist_initial_temp, PricePath_temp, ParamPath_temp, PolicyPath_temp, n_d_temp,n_a_temp,n_z_temp,pi_z_temp,T, Parameters_temp, simoptions_temp);    end

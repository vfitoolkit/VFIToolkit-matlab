function Fmatrix=CreateReturnFnMatrix_Case2_Disc_Par2e(ReturnFn,n_d, n_a, n_z, n_e, d_grid, a_grid, z_grid, e_grid, ReturnFnParams)
...
Fmatrix=reshape(Fmatrix,[N_d,N_a,N_z,N_e]);

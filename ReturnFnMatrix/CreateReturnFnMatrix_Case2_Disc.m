function Fmatrix=CreateReturnFnMatrix_Case2_Disc(ReturnFn, n_d, n_a, n_z, d_grid, a_grid, z_grid, Parallel)
...
elseif Parallel==1
    ...
    parfor i3=1:N_z
        ...
        for i1=1:N_d
            for i2=1:N_a
                Fmatrix_z(i1,i2)=ReturnFn(d_gridvals(i1,:),a_gridvals(i2,:),z_gridvals_temp);
            end
        end

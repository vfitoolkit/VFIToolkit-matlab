...
% FOLLOWING IS THE OLD VERSION, JUST DON't WANT TO DELETE IT UNTIL I HAVE
% MORE CONFIDENCE IN NEW VERSION :)

% if N_d==0
%     if l_a==1
%         a1primevals=a_grid;
%         a1vals=shiftdim(a_grid,-1);
%         if l_z==1
%             zvals=shiftdim(z_grid,-2);
%             Fmatrix=arrayfun(ReturnFn, a1primevals, a1vals, zvals, ParamCell{:});
%         elseif l_z==2
...
%     
%     if l_d==1 
%         d1vals=d_grid; d1vals(1,1,1)=d_grid(1);
%         if l_a==1
%             a1primevals=shiftdim(a_grid,-1);
%             a1vals=shiftdim(a_grid,-2);
%             if l_z==1
%                 z1vals=shiftdim(z_grid,-3);
%                 Fmatrix=arrayfun(ReturnFn, d1vals, a1primevals, a1vals, z1vals, ParamCell{:});
%             elseif l_z==2
%                 z1vals=shiftdim(z_grid(1:n_z(1)),-3);
%                 z2vals=shiftdim(z_grid(n_z(1)+1:n_z(1)+n_z(2)),-4);
%                 Fmatrix=arrayfun(ReturnFn, d1vals, a1primevals, a1vals, z1vals,z2vals, ParamCell{:});
%             elseif l_z==3
%                 z1vals=shiftdim(z_grid(1:n_z(1)),-3);
%                 z2vals=shiftdim(z_grid(n_z(1)+1:n_z(1)+n_z(2)),-4);
%                 z3vals=shiftdim(z_grid(sum(n_z(1:2))+1:sum(n_z(1:3))),-5);
%                 Fmatrix=arrayfun(ReturnFn, d1vals, a1primevals, a1vals, z1vals,z2vals,z3vals, ParamCell{:});
%             elseif l_z==4
%                 z1vals=shiftdim(z_grid(1:n_z(1)),-3);
%                 z2vals=shiftdim(z_grid(n_z(1)+1:n_z(1)+n_z(2)),-4);
%                 z3vals=shiftdim(z_grid(sum(n_z(1:2))+1:sum(n_z(1:3))),-5);
%                 z4vals=shiftdim(z_grid(sum(n_z(1:3))+1:sum(n_z(1:4))),-6);
%                 Fmatrix=arrayfun(ReturnFn, d1vals, a1primevals, a1vals, z1vals,z2vals,z3vals,z4vals, ParamCell{:});
%             end
%         elseif l_a==2 
...
%                 Fmatrix=arrayfun(ReturnFn, d1vals, a1primevals,a2primevals, a1vals,a2vals, zvals, ParamCell{:});
%             elseif l_z==2
%                 z1vals=shiftdim(z_grid(1:n_z(1)),-5);
%                 z2vals=shiftdim(z_grid(n_z(1)+1:n_z(1)+n_z(2)),-6);
%                 Fmatrix=arrayfun(ReturnFn, d1vals, a1primevals, a2primevals, a1vals,a2vals, z1vals,z2vals, ParamCell{:});
%             elseif l_z==3
%                 z1vals=shiftdim(z_grid(1:n_z(1)),-5);
%                 z2vals=shiftdim(z_grid(n_z(1)+1:n_z(1)+n_z(2)),-6);
%                 z3vals=shiftdim(z_grid(sum(n_z(1:2))+1:sum(n_z(1:3))),-7);
%                 Fmatrix=arrayfun(ReturnFn, d1vals, a1primevals, a2primevals, a1vals,a2vals, z1vals,z2vals,z3vals, ParamCell{:});
%             elseif l_z==4
%                 z1vals=shiftdim(z_grid(1:n_z(1)),-5);
%                 z2vals=shiftdim(z_grid(n_z(1)+1:n_z(1)+n_z(2)),-6);
%                 z3vals=shiftdim(z_grid(sum(n_z(1:2))+1:sum(n_z(1:3))),-7);
%                 z4vals=shiftdim(z_grid(sum(n_z(1:3))+1:sum(n_z(1:4))),-8);
%                 Fmatrix=arrayfun(ReturnFn, d1vals, a1primevals, a2primevals, a1vals,a2vals, z1vals,z2vals,z3vals,z4vals, ParamCell{:});
%             end
%         elseif l_a==3
%             a1primevals=shiftdim(a_grid(1:n_a(1)),-1);
...
%                 Fmatrix=arrayfun(ReturnFn, d1vals, a1primevals,a2primevals,a3primevals, a1vals,a2vals,a3vals, zvals, ParamCell{:});
%             elseif l_z==2
%                 z1vals=shiftdim(z_grid(1:n_z(1)),-7);
%                 z2vals=shiftdim(z_grid(n_z(1)+1:n_z(1)+n_z(2)),-8);
%                 Fmatrix=arrayfun(ReturnFn, d1vals, a1primevals, a2primevals,a3primevals, a1vals,a2vals,a3vals, z1vals,z2vals, ParamCell{:});
%             elseif l_z==3
%                 z1vals=shiftdim(z_grid(1:n_z(1)),-7);
%                 z2vals=shiftdim(z_grid(n_z(1)+1:n_z(1)+n_z(2)),-8);
%                 z3vals=shiftdim(z_grid(sum(n_z(1:2))+1:sum(n_z(1:3))),-9);
%                 Fmatrix=arrayfun(ReturnFn, d1vals, a1primevals, a2primevals,a3primevals, a1vals,a2vals,a3vals, z1vals,z2vals,z3vals, ParamCell{:});
%             elseif l_z==4
%                 z1vals=shiftdim(z_grid(1:n_z(1)),-7);
%                 z2vals=shiftdim(z_grid(n_z(1)+1:n_z(1)+n_z(2)),-8);
%                 z3vals=shiftdim(z_grid(sum(n_z(1:2))+1:sum(n_z(1:3))),-9);
%                 z4vals=shiftdim(z_grid(sum(n_z(1:3))+1:sum(n_z(1:4))),-10);
%                 Fmatrix=arrayfun(ReturnFn, d1vals, a1primevals, a2primevals,a3primevals, a1vals,a2vals,a3vals, z1vals,z2vals,z3vals,z4vals, ParamCell{:});
%             end
%         elseif l_a==4
%             a1primevals=shiftdim(a_grid(1:n_a(1)),-1);
%             a2primevals=shiftdim(a_grid(n_a(1)+1:sum(n_a(1:2))),-2);
...
%             if l_z==1
%                 zvals=shiftdim(z_grid,-7);
%                 Fmatrix=arrayfun(ReturnFn, d1vals, a1primevals,a2primevals,a3primevals,a4primevals, a1vals,a2vals,a3vals,a4vals, zvals, ParamCell{:});
%             elseif l_z==2
%                 z1vals=shiftdim(z_grid(1:n_z(1)),-7);
%                 z2vals=shiftdim(z_grid(n_z(1)+1:n_z(1)+n_z(2)),-8);
%                 Fmatrix=arrayfun(ReturnFn, d1vals, a1primevals, a2primevals,a3primevals,a4primevals, a1vals,a2vals,a3vals,a4vals, z1vals,z2vals, ParamCell{:});
%             elseif l_z==3
%                 z1vals=shiftdim(z_grid(1:n_z(1)),-7);
%                 z2vals=shiftdim(z_grid(n_z(1)+1:n_z(1)+n_z(2)),-8);
%                 z3vals=shiftdim(z_grid(sum(n_z(1:2))+1:sum(n_z(1:3))),-9);
%                 Fmatrix=arrayfun(ReturnFn, d1vals, a1primevals, a2primevals,a3primevals,a4primevals, a1vals,a2vals,a3vals,a4vals, z1vals,z2vals,z3vals, ParamCell{:});
%             elseif l_z==4
%                 z1vals=shiftdim(z_grid(1:n_z(1)),-7);
%                 z2vals=shiftdim(z_grid(n_z(1)+1:n_z(1)+n_z(2)),-8);
%                 z3vals=shiftdim(z_grid(sum(n_z(1:2))+1:sum(n_z(1:3))),-9);
%                 z4vals=shiftdim(z_grid(sum(n_z(1:3))+1:sum(n_z(1:4))),-10);
%                 Fmatrix=arrayfun(ReturnFn, d1vals, a1primevals, a2primevals,a3primevals,a4primevals, a1vals,a2vals,a3vals,a4vals, z1vals,z2vals,z3vals,z4vals, ParamCell{:});
%             end
%         end
%     elseif l_d==2
%         d1vals=d_grid(1:n_d(1));
...
%         if l_a==1
%             a1primevals=shiftdim(a_grid,-2);
%             a1vals=shiftdim(a_grid,-3);
%             if l_z==1
%                 zvals=shiftdim(z_grid,-4);
%                 Fmatrix=arrayfun(ReturnFn, d1vals,d2vals, a1primevals, a1vals, zvals, ParamCell{:});
%             elseif l_z==2
%                 z1vals=shiftdim(z_grid(1:n_z(1)),-4);
%                 z2vals=shiftdim(z_grid(n_z(1)+1:n_z(1)+n_z(2)),-5);
%                 Fmatrix=arrayfun(ReturnFn, d1vals,d2vals, a1primevals, a1vals, z1vals,z2vals, ParamCell{:});
%             elseif l_z==3
%                 z1vals=shiftdim(z_grid(1:n_z(1)),-4);
%                 z2vals=shiftdim(z_grid(n_z(1)+1:n_z(1)+n_z(2)),-5);
%                 z3vals=shiftdim(z_grid(sum(n_z(1:2))+1:sum(n_z(1:3))),-6);
%                 Fmatrix=arrayfun(ReturnFn, d1vals,d2vals, a1primevals, a1vals, z1vals,z2vals,z3vals, ParamCell{:});
%             elseif l_z==4
%                 z1vals=shiftdim(z_grid(1:n_z(1)),-4);
%                 z2vals=shiftdim(z_grid(n_z(1)+1:n_z(1)+n_z(2)),-5);
%                 z3vals=shiftdim(z_grid(sum(n_z(1:2))+1:sum(n_z(1:3))),-6);
%                 z4vals=shiftdim(z_grid(sum(n_z(1:3))+1:sum(n_z(1:4))),-7);
%                 Fmatrix=arrayfun(ReturnFn, d1vals,d2vals, a1primevals, a1vals, z1vals,z2vals,z3vals,z4vals, ParamCell{:});
%             end
%         elseif l_a==2
...
%         if l_a==1
%             a1primevals=shiftdim(a_grid,-3);
%             a1vals=shiftdim(a_grid,-4);
%             if l_z==1
%                 zvals=shiftdim(z_grid,-5);
%                 Fmatrix=arrayfun(ReturnFn, d1vals,d2vals,d3vals, a1primevals, a1vals, zvals, ParamCell{:});
%             elseif l_z==2
%                 z1vals=shiftdim(z_grid(1:n_z(1)),-5);
%                 z2vals=shiftdim(z_grid(n_z(1)+1:n_z(1)+n_z(2)),-6);
%                 Fmatrix=arrayfun(ReturnFn, d1vals,d2vals,d3vals, a1primevals, a1vals, z1vals,z2vals, ParamCell{:});
%             elseif l_z==3
%                 z1vals=shiftdim(z_grid(1:n_z(1)),-5);
%                 z2vals=shiftdim(z_grid(n_z(1)+1:n_z(1)+n_z(2)),-6);
%                 z3vals=shiftdim(z_grid(sum(n_z(1:2))+1:sum(n_z(1:3))),-7);
%                 Fmatrix=arrayfun(ReturnFn, d1vals,d2vals,d3vals, a1primevals, a1vals, z1vals,z2vals,z3vals, ParamCell{:});
%             elseif l_z==4
%                 z1vals=shiftdim(z_grid(1:n_z(1)),-5);
%                 z2vals=shiftdim(z_grid(n_z(1)+1:n_z(1)+n_z(2)),-6);
%                 z3vals=shiftdim(z_grid(sum(n_z(1:2))+1:sum(n_z(1:3))),-7);
%                 z4vals=shiftdim(z_grid(sum(n_z(1:3))+1:sum(n_z(1:4))),-8);
%                 Fmatrix=arrayfun(ReturnFn, d1vals,d2vals,d3vals, a1primevals, a1vals, z1vals,z2vals,z3vals,z4vals, ParamCell{:});
%             end
%         elseif l_a==2
...
%         if l_a==1
%             a1primevals=shiftdim(a_grid,-4);
%             a1vals=shiftdim(a_grid,-5);
%             if l_z==1
%                 zvals=shiftdim(z_grid,-6);
%                 Fmatrix=arrayfun(ReturnFn, d1vals,d2vals,d3vals,d4vals, a1primevals, a1vals, zvals, ParamCell{:});
%             elseif l_z==2
%                 z1vals=shiftdim(z_grid(1:n_z(1)),-6);
%                 z2vals=shiftdim(z_grid(n_z(1)+1:n_z(1)+n_z(2)),-7);
%                 Fmatrix=arrayfun(ReturnFn, d1vals,d2vals,d3vals,d4vals, a1primevals, a1vals, z1vals,z2vals, ParamCell{:});
%             elseif l_z==3
%                 z1vals=shiftdim(z_grid(1:n_z(1)),-6);
%                 z2vals=shiftdim(z_grid(n_z(1)+1:n_z(1)+n_z(2)),-7);
%                 z3vals=shiftdim(z_grid(sum(n_z(1:2))+1:sum(n_z(1:3))),-8);
%                 Fmatrix=arrayfun(ReturnFn, d1vals,d2vals,d3vals,d4vals, a1primevals, a1vals, z1vals,z2vals,z3vals, ParamCell{:});
%             elseif l_z==4
%                 z1vals=shiftdim(z_grid(1:n_z(1)),-6);
%                 z2vals=shiftdim(z_grid(n_z(1)+1:n_z(1)+n_z(2)),-7);
%                 z3vals=shiftdim(z_grid(sum(n_z(1:2))+1:sum(n_z(1:3))),-8);
%                 z4vals=shiftdim(z_grid(sum(n_z(1:3))+1:sum(n_z(1:4))),-9);
%                 Fmatrix=arrayfun(ReturnFn, d1vals,d2vals,d3vals,d4vals, a1primevals, a1vals, z1vals,z2vals,z3vals,z4vals, ParamCell{:});
%             end
%         elseif l_a==2

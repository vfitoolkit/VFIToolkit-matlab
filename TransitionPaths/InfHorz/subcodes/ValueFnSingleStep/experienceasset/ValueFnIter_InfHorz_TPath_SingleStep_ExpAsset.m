...
elseif vfoptions.divideandconquer==1 && vfoptions.gridinterplayer==1
    if N_a1==0
        ...
        if N_d1==0
            % [VKron,PolicyKron]=ValueFnIter_InfHorz_TPath_SingleStep_ExpAsset_DC1_GI_nod1_raw(VKron,n_d2, n_a1, n_a2, n_z, d2_gridvals, a1_gridvals, a2_grid, z_gridvals, pi_z, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions);
        else
            % [VKron, PolicyKron]=ValueFnIter_InfHorz_TPath_SingleStep_ExpAsset_DC1_GI_raw(VKron,n_d,n_a,n_z, d_gridvals, d2_gridvals, a1_gridvals, a2_grid, z_gridvals, pi_z, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions);
        end
    end
end

function AgentDist=AgentDist_InfHorz_TPath_SingleStep_raw(AgentDist,Policy_aprimez,II1,II2,N_a,N_z,pi_z_sparse)
% II1 and II2 are inputs just so they can be precomputed and then reused each period of transition
% II1=gpuArray(1:1:N_a*N_z);
% II2=ones(N_a*N_z,1,'gpuArray');
...
Gammatranspose=sparse(gather(Policy_aprimez),II1,II2,N_a*N_z,N_a*N_z);

...
if N_z==0 && N_e==0
    ...
    if N_probs==1
        ...
        AgentDistnext=AgentDist_InfHorz_TPath_SingleStep_nProbs_noz_raw(AgentDist,PolicyPath_ForAgentDistIter(:,:,tt),II2,PolicyProbsPath(:,:,tt),N_a,N_e,pi_e_sparse);
    end
elseif N_z>0 && N_e==0
    if N_probs==1
        ...
        AgentDistnext=AgentDist_InfHorz_TPath_SingleStep_nProbs_raw(AgentDist,PolicyPath_ForAgentDistIter(:,:,tt),II2,PolicyProbsPath(:,:,tt),N_a,N_z,pi_z_sparse);
    end
elseif N_z==0 && N_e>0
    error('Not yet implemented')
    if N_probs==1
        ...
        AgentDistnext=AgentDist_InfHorz_TPath_SingleStep_nProbs_noz_e_raw(AgentDist,PolicyPath_ForAgentDistIter(:,:,tt),II2,PolicyProbsPath(:,:,tt),N_a,N_e,pi_e_sparse);
    end
elseif N_z>0 && N_e>0
    error('Not yet implemented')
    if N_probs==1
        ...
        AgentDistnext=AgentDist_InfHorz_TPath_SingleStep_nProbs_e_raw(AgentDist,PolicyPath_ForAgentDistIter(:,:,tt),II2,PolicyProbsPath(:,:,tt),N_a,N_z,N_e,pi_z_sparse,pi_e_sparse);
    end
end

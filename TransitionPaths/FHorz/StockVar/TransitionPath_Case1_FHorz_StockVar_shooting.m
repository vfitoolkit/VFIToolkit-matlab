...
%     StockVarsPathOld=StockVarsPathNew;
    ...
    StockVarsPathConvergence=StockVarsPathDist/transpathoptions.tolerance;
    if transpathoptions.verbose==1
        ...
        fprintf('Current distance to convergence stock variables path: %.2f (convergence not actually required) \n', StockVarsPathConvergence)
    end
...
%     end
    ...
    if transpathoptions.historyofpricepath==1
        ...
        PricePathHistory{pathcounter,3}=StockVarsPathNew;

...
while PricePathDist>transpathoptions.tolerance && pathcounter<=transpathoptions.maxiter
    ...
    for tt=1:T-1
        ...
        AgentDist=StationaryDist_FHorz_Case1_TPath_SingleStep_IterFast_noz_raw(AgentDist,reshape(Policy(1,:,1:end-1),[1,N_a*(N_j-1)]),N_a,N_j,jequalOneDist);
    end

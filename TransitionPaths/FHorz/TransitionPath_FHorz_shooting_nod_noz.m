...
while PricePathDist>transpathoptions.tolerance && pathcounter<=transpathoptions.maxiter
    ...
    elseif simoptions.fastOLG==1
        ...
        if simoptions.gridinterplayer==1
            L2index=reshape(PolicyIndexesPath(l_aprime+1,:,1:N_j-1,:),[1,N_a,N_j-1,T-1]); % PolicyPath is of size [l_d+l_aprime+1,N_a,N_j,T]
    ...
    PolicyValuesPath=PolicyInd2Val_FHorz_TPath(PolicyIndexesPath,0,n_a,0,N_j,T-1,[],a_grid,vfoptions,1,0);

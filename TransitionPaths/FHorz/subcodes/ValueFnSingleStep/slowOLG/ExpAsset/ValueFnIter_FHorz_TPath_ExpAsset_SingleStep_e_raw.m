function [V,Policy3]=ValueFnIter_FHorz_TPath_ExpAsset_SingleStep_e_raw(V,n_d1,n_d2,n_a1,n_a2,n_z,n_e,N_j, d_gridvals, d2_grid, a1_gridvals, a2_grid, z_gridvals_J, e_gridvals_J, pi_z_J, pi_e_J, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, aprimeFnParamNames, vfoptions)
...
for reverse_j=1:N_j-1
    ...
    elseif vfoptions.lowmemory==3
        for ea_c=1:N_a2
            ...
            for z_c=1:N_z
                z_val=z_gridvals_J(z_c,:,jj);
                DiscountedEV_z=DiscountFactorParamsVec*repelem(EV(:,ea_c,z_c),N_d1,N_a1);
                for e_c=1:N_e
                    e_val=e_gridvals_J(e_c,:,jj);

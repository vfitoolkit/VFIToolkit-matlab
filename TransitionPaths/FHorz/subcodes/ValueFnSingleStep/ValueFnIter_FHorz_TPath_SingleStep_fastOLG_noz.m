    ...
    if vfoptions.divideandconquer==0
        if vfoptions.gridinterplayer==0
            ...
            if N_d==0
                ...
                [VKron, PolicyKron]=ValueFnIter_FHorz_TPath_SingleStep_fastOLG_GI_noz_raw(VKron, n_d, n_a, N_j, d_grid, a_grid, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames,vfoptions);
            end
        end
    elseif vfoptions.divideandconquer==1
        if vfoptions.gridinterplayer==0
            ...
            if N_d==0
                ...
                [VKron, PolicyKron]=ValueFnIter_FHorz_TPath_SingleStep_fastOLG_DC1_GI_noz_raw(VKron, n_d, n_a, N_j, d_grid, a_grid, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames,vfoptions);
            end
        end
    end
end

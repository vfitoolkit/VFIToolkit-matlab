    ...
    if vfoptions.divideandconquer==0
        if vfoptions.gridinterplayer==0
            ...
            if N_d==0
                ...
                [VKron, PolicyKron]=ValueFnIter_FHorz_TPath_SingleStep_fastOLG_GI_noz_e_raw(VKron,n_d,n_a, n_e, N_j, d_gridvals, a_grid, e_gridvals_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions);
            end
        end
        ...
        if vfoptions.gridinterplayer==0
            ...
            if N_d==0
                ...
                [VKron, PolicyKron]=ValueFnIter_FHorz_TPath_SingleStep_fastOLG_DC1_GI_noz_e_raw(VKron,n_d,n_a, n_e, N_j, d_gridvals, a_grid, e_gridvals_J, pi_e_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions);
            end
        end
    end
else 

...
if vfoptions.lowmemory==0
    ...
    linidx_lower=reshape(dind,[1,N_a1*N_a2,N_j,N_e])                   +N_d2*n2long*shiftdim(gpuArray(0:1:N_a-1),-1)+N_d2*n2long*N_a*shiftdim(gpuArray(0:1:N_j-1),-2)+N_d2*n2long*N_a*N_j*shiftdim(gpuArray(0:1:N_e-1),-3);
    linidx_upper=reshape(dind,[1,N_a1*N_a2,N_j,N_e])+N_d2*(n2long-1)   +N_d2*n2long*shiftdim(gpuArray(0:1:N_a-1),-1)+N_d2*n2long*N_a*shiftdim(gpuArray(0:1:N_j-1),-2)+N_d2*n2long*N_a*N_j*shiftdim(gpuArray(0:1:N_e-1),-3);

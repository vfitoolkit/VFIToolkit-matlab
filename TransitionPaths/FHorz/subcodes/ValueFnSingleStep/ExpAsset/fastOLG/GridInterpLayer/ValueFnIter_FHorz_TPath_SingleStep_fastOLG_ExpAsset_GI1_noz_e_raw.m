...
if vfoptions.lowmemory==0
    ReturnMatrix=CreateReturnFnMatrix_fastOLG_ExpAsset_Disc(ReturnFn, n_d1, n_d2, n_a1, n_a1,n_a2, n_e,N_j, d_gridvals, a1_gridvals, a1_gridvals, a2_grid, e_gridvals_J, ReturnFnParamsAgeMatrix,1,0); % Level=1, Refine=0
    % fastOLG: ReturnMatrix is [N_d,N_a1prime,N_a1,N_a2,N_j,N_e]
    ...
    linidx_lower=reshape(dind,[1,N_a1*N_a2,N_j,N_e])                  +N_d*n2long*shiftdim(gpuArray(0:1:N_a-1),-1)+N_d*n2long*N_a*shiftdim(gpuArray(0:1:N_j-1),-2)+N_d*n2long*N_a*N_j*shiftdim(gpuArray(0:1:N_e-1),-3);
    linidx_upper=reshape(dind,[1,N_a1*N_a2,N_j,N_e])+N_d*(n2long-1)   +N_d*n2long*shiftdim(gpuArray(0:1:N_a-1),-1)+N_d*n2long*N_a*shiftdim(gpuArray(0:1:N_j-1),-2)+N_d*n2long*N_a*N_j*shiftdim(gpuArray(0:1:N_e-1),-3);

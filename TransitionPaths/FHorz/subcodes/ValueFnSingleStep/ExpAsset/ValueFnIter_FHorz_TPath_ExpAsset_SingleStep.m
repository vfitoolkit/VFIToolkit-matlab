function [VKron, PolicyKron]=ValueFnIter_FHorz_TPath_ExpAsset_SingleStep(VKron,n_d,n_a,n_z,N_j,d_gridvals, a_grid, z_gridvals_J, pi_z_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
% The VKron input is next period value fn, the VKron output is this period.

error("these are not yet the droids you are looking for")

...
if vfoptions.lowmemory>0
    error('vfoptions.lowmemory>0 not supported for ValueFnIter_FHorz_TPath_SingleStep_fastOLG_GI2A_nod_raw')
end

N_a=prod(n_a);
N_z=prod(n_z);

% Policy: 3 channels (aprime_kron_lower, L2ind, L2flag), matching fastOLG_GI1_nod convention.
Policy=zeros(3,N_a,N_j,N_z,'gpuArray');

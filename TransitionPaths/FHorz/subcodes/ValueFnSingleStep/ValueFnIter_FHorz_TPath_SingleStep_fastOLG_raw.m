function [V,Policy]=ValueFnIter_FHorz_TPath_SingleStep_fastOLG_raw(V,n_d,n_a,n_z,N_j, d_grid, a_grid, z_gridvals_J, pi_z_J, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)
...
elseif vfoptions.lowmemory==1
    ...
    for z_c=1:N_z
        ...
        discountedEV_z=repelem(reshape(DiscountFactorParamsVec.*EV_z,[N_a,N_j]),N_d,N_a); % (d,aprime)-by-(a,j)

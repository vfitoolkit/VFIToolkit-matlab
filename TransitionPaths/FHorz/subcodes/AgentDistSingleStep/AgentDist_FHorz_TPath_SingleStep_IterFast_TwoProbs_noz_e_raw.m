function AgentDist=AgentDist_FHorz_TPath_SingleStep_IterFast_TwoProbs_noz_e_raw(AgentDist,Policy_aprime,PolicyProbs,N_a,N_e,N_j,pi_e_J_sim,exceptlastj,exceptfirstj,justfirstj,jequalOneDist)
...
% Policy_aprime is [N_a*(N_j-1)*N_e,2]
% PolicyProbs is [N_a*(N_j-1)*N_e,2]
...
firststep=Policy_aprime+N_a*repmat(repelem((0:1:N_j-2)',N_a,1),N_e,2);
II=repelem((1:1:N_a*(N_j-1)*N_e)',1,2);

Gammatranspose=sparse(firststep,II,PolicyProbs,N_a*(N_j-1),N_a*(N_j-1)*N_e);
% Note: N_j-1, not N_j

...
II2=repelem((1:1:N_asemiz*(N_j-1)*N_z*N_e)',1,N_semizshort);
Gammatranspose=sparse(Policy_aprimesemizz,II2,semiztransitions,N_asemiz*(N_j-1)*N_z,N_asemiz*(N_j-1)*N_z*N_e); % From (a,semiz,j,z,e) to (a',semiz',j,z)

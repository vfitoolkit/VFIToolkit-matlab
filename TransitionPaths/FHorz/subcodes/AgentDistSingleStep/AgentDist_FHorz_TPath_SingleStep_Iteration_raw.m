function AgentDist=AgentDist_FHorz_TPath_SingleStep_Iteration_raw(AgentDist,Policy_aprimez,N_a,N_z,N_j,pi_z_J,II1,II2,jequalOneDist)
...
for jjr=1:(N_j-1)
    ...
    % Tan improvement
    Gammatranspose=sparse(Policy_aprimez(:,jj),II1,II2,N_a*N_z,N_a*N_z);

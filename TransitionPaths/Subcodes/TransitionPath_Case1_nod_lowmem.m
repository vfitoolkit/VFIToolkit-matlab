...
%         end
    ...
    for tt=1:T-1
        ...
        AggVars=EvalFnOnAgentDist_AggVars_Case1(gpuArray(full(AgentDist)), PolicyTemp, FnsToEvaluate, Parameters, FnsToEvaluateParamNames, 0, n_a, n_z, 0, a_grid, z_gridvals, 2,simoptions);

function [V,Policy]=ValueFnIter_InfHorz_TPath_SingleStep_ExpAsset_DC1_nod1_raw(Vnext,n_d2,n_a1, n_a2,n_z, d2_grid, a1_grid, a2_grid, z_gridvals, pi_z, ReturnFn, aprimeFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames,aprimeFnParamNames, vfoptions)
...
if vfoptions.lowmemory==0
    ...
    % n-Monotonicity
    ReturnMatrix_ii=CreateReturnFnMatrix_Case1_ExpAsset_Disc_DC1_Par2(ReturnFn, n_d2, n_z, d2_gridvals, a1_grid, a1_grid(level1ii), a2_grid, z_gridvals, ReturnFnParamsVec,1);

...
%             end
    ...
    if transpathoptions.verbose==1
        disp('Old, New, GEcondns')
        [PricePathOld,PricePathNew,GEcondnspath]
%         disp('Old, New')

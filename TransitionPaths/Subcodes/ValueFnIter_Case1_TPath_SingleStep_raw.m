function [V,Policy2]=ValueFnIter_Case1_TPath_SingleStep_raw(Vnext,n_d,n_a,n_z, d_grid, a_grid, z_grid, pi_z, ReturnFn, Parameters, DiscountFactorParamNames, ReturnFnParamNames, vfoptions)

...
while PricePathDist>transpathoptions.tolerance && pathcounter<transpathoptions.maxiterations
    ...
    for i=1:T-1 %so t=T-i
        ...
        parfor z_c=1:N_z
            ReturnMatrix_z=CreateReturnFnMatrix_Case1_Disc(ReturnFn, n_d, n_a, ones(l_z,1), d_grid, a_grid, z_gridvals(z_c,:),0,ReturnFnParamsVec);

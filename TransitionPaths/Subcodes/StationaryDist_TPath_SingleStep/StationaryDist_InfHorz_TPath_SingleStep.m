function AgentDist=StationaryDist_InfHorz_TPath_SingleStep(AgentDist,Policy_aprimez,N_a,N_z,pi_z_sparse)

Gammatranspose=sparse(Policy_aprimez,1:1:N_a*N_z,ones(N_a*N_z,1),N_a*N_z,N_a*N_z);

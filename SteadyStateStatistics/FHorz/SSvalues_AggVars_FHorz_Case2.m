function SSvalues_AggVars=SSvalues_AggVars_FHorz_Case2(StationaryDist, PolicyIndexes, FnsToEvaluateFn, Parameters,FnsToEvaluateParamNames, n_d, n_a, n_z, N_j, d_grid, a_grid, z_grid, options, AgeDependentGridParamNames) %pi_z,p_val
...
if isa(StationaryDist,'struct')
    ...
    SSvalues_AggVars=SSvalues_AggVars_FHorz_Case2_AgeDepGrids(StationaryDist, PolicyIndexes, FnsToEvaluateFn, Parameters,FnsToEvaluateParamNames, n_d, n_a, n_z, N_j, d_grid, a_grid, z_grid, options, AgeDependentGridParamNames);
    return
end
...
if isa(StationaryDist,'gpuArray')% Parallel==2
    ...
    for i=1:length(FnsToEvaluateFn)
        ...
        for jj=1:N_j
            ...
            Values(:,jj)=reshape(ValuesOnSSGrid_Case2(FnsToEvaluateFn{i}, SSvalueParamsVec,PolicyValuesPermute,n_d,n_a,n_z,a_grid,z_grid,2),[N_a*N_z,1]);
        end

function SSvalues_InvertedParetoCoeff=SSvalues_InvertedParetoCoeff_Case1(SteadyStateDist, PolicyIndexes, SSvaluesFn, n_d, n_a, n_s, d_grid, a_grid, s_grid, pi_s,p_val)
disp('THIS CODE (SSvalues_InvertedParetoCoeff_Case1) IS INCOMPLETE. DO NOT USE.')
...
x_m=zeros(length(SSvaluesFn),1);
alpha=zeros(length(SSvaluesFn),1);

function SSvalues_LorenzCurve=SSvalues_LorenzCurve_Case2(StationaryDist, PolicyIndexes, SSvaluesFn, Parameters,SSvalueParamNames, n_d, n_a, n_z, d_grid, a_grid, z_grid,Parallel, npoints)

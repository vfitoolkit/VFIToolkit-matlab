function SimTimeSeriesKron=SimTimeSeriesIndexes_InfHorz_PolicyProbs_semiz_noz_e_raw(Policy_aprime,CumPolicyProbs,Policy_dsemiexo,cumsumpi_semiz,cumsumpi_e,simoptions,seedpoint)
...
for tt=1:simoptions.simperiods
    ...
    SimTimeSeriesKron(3,tt)=currstate(3); % e

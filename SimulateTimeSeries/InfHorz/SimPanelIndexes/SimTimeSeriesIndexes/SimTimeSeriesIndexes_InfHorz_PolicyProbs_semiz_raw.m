function SimTimeSeriesKron=SimTimeSeriesIndexes_InfHorz_PolicyProbs_semiz_raw(Policy_aprime,CumPolicyProbs,Policy_dsemiexo,cumsumpi_z,cumsumpi_semiz,simoptions,seedpoint)
% All inputs must be on the CPU

currstate=seedpoint; % seedpoint is (a,semiz,z)

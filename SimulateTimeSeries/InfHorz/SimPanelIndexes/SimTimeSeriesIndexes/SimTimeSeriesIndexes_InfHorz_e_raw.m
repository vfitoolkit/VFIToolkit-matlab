function SimTimeSeriesKron=SimTimeSeriesIndexes_InfHorz_e_raw(Policy_aprime,cumsumpi_z,cumsumpi_e,simoptions,seedpoint)
% All inputs must be on the CPU

currstate=seedpoint; % seedpoint is (a,z,e)

% Simulation is simoptions.simperiods
...
for tt=1:simoptions.simperiods
    ...
    currstate(1)=Policy_aprime(currstate(1),currstate(2),currstate(3));

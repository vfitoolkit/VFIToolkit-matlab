...
if simoptions.n_e(1)==0
    ...
    if simoptions.parallel==0
        for ii=1:simoptions.numbersims
            ...
            SimPanel(:,:,ii)=SimLifeCycleIndexes_FHorz_Case1_semiz_raw(PolicyKron,N_semiz,N_j,cumsumpi_z_J,cumsumpi_semiz_J, seedpoint, simperiods);
        end
    else
        parfor ii=1:simoptions.numbersims % This is only change from the simoptions.parallel==0
            seedpoint=seedpoints(ii,:);
            SimLifeCycleKron=SimLifeCycleIndexes_FHorz_Case1_semiz_raw(PolicyKron,N_semiz,N_j,cumsumpi_z_J,cumsumpi_semiz_J, seedpoint, simperiods);
    ...
    if simoptions.parallel==0
        for ii=1:simoptions.numbersims
            seedpoint=seedpoints(ii,:);
            SimPanel(:,:,ii)=SimLifeCycleIndexes_FHorz_Case1_semiz_e_raw(PolicyKron,N_semiz,N_j,cumsumpi_z_J,cumsumpi_semiz_J,cumsumpi_e_J, seedpoint, simperiods);
        end
    else
        parfor ii=1:simoptions.numbersims % This is only change from the simoptions.parallel==0
            seedpoint=seedpoints(ii,:);
            SimLifeCycleKron=SimLifeCycleIndexes_FHorz_Case1_semiz_e_raw(PolicyKron,N_semiz,N_j,cumsumpi_z_J,cumsumpi_semiz_J,cumsumpi_e_J, seedpoint, simperiods);
            SimPanel(:,:,ii)=SimLifeCycleKron;
        end
    end

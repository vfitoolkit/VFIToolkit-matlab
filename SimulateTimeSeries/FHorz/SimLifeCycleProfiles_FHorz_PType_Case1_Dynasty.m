function SimPanelValues=SimLifeCycleProfiles_FHorz_PType_Case1_Dynasty(InitialDist,Policy,FnsToEvaluate,FnsToEvaluateParamNames,Parameters,n_d,n_a,n_z,N_j,d_gridfn,a_gridfn,z_gridfn,AgeDependentGridParamNames, Phi_aprimeFn,Case2_Type,PhiaprimeParamNames, simoptions)
fprintf('ERROR: SimLifeCycleProfiles_FHorz_PType_Case1_Dynasty not yet implemented!!! \n')

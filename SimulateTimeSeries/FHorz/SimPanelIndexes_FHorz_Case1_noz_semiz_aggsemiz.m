function SimPanel=SimPanelIndexes_FHorz_Case1_noz_semiz_aggsemiz(InitialDist,Policy,n_d,n_a,N_j, simoptions)
...
%% Aggregate semiz
% First, calculate the transition matrix for the aggregate shock
% Second, simulate the aggregate shock
% Third, 

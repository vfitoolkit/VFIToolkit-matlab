function SimLifeCycleKron=SimLifeCycleIndexes_FHorz_Case1_semiz_e_raw(PolicyKron,N_semiz,N_z,N_j,cumsumpi_z_J,cumsumpi_semiz_J,cumsumpi_e_J,seedpoint,simperiods)

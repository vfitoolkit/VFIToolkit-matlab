function SimLifeCycleKron=SimLifeCycleIndexes_FHorz_ExpAsset_semiz_e_raw(Policy_aprime,CumPolicyProbs,Policy_dsemiexo,N_j,cumsumpi_z_J,cumsumpi_semiz_J,cumsumpi_e_J,simoptions,seedpoint)

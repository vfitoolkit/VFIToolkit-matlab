function SimLifeCycleKron=SimLifeCycleIndexes_FHorz_PolicyProbs_semiz_noz_raw(Policy_aprime,CumPolicyProbs,Policy_dsemiexo,N_j,cumsumpi_semiz_J,simoptions,seedpoint)
...
SimLifeCycleKron=nan(3,N_j); % (a,semiz,j)
for jj=0:periods

function [CalibParams,calibsummary]=CalibrateBIHAModel(CalibParamNames,TargetMoments,n_d,n_a,n_z,d_grid, a_grid, z_grid, pi_z, ReturnFn, Parameters, DiscountFactorParamNames, ParametrizeParamsFn, GEPriceParamNames, FnsToEvaluate, GeneralEqmEqns, heteroagentoptions, caliboptions, vfoptions,simoptions)
...
if ~isfield(heteroagentoptions,'multiGEweights')
    ...
    if size(heteroagentoptions.multiGEweights,1)>1

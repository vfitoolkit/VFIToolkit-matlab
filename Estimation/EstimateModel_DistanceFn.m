function Dist=EstimateModel_DistanceFn(CalibParamsVec, ModelTargetsFn, Parameters, EstimationTargetsVec, ParamNamesToEstimate, NamesEstimationTargets, CalibDistTypeVec, CalibWeightsVec, Verbose, NestedFixedPt)

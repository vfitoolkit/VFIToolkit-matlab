...
if isfield(caliboptions,'progressreport') && caliboptions.progressreport==1
    ...
    if ~isnan(currentObj)
        ...
        CalibrateBIHAModel_ProgressReport(caliboptions,currentObj,CalibParamNames,calibparamsvec,calibparamsvecindex,currentmomentvec,targetmomentvec,momentnames,GEPriceParamNames,Parameters,{},GeneralEqmConditionsVec);
    end
end

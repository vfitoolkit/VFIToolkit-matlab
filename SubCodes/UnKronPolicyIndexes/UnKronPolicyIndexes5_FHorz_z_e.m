...
if l_daprime1==1 && l_daprime2==1 && l_daprime3==1 && l_daprime4==1 && l_daprime5==1
    ...
    if vfoptions.gridinterplayer==1
        Policy=reshape(PolicyKron,[l_daprime1+l_daprime2+l_daprime3+l_daprime4+l_daprime5+2,n_a,n_z,n_e,N_j]);
    else
        Policy=reshape(PolicyKron,[l_daprime1+l_daprime2+l_daprime3+l_daprime4+l_daprime5,n_a,n_z,n_e,N_j]);
    end
